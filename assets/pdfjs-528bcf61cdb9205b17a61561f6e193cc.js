...
const r=[]
for(let s=0;s<t;s+=8192){const n=Math.min(s+8192,t),i=e.subarray(s,n)
r.push(String.fromCharCode.apply(null,i))}return r.join("")},t.createPromiseCapability=function(){const e=Object.create(null)
let t=!1
...
return r}function u(e){return void 0!==e.length?e.length:(o(void 0!==e.byteLength),e.byteLength)}const p={get value(){return l(this,"value",function(){const e=new Uint8Array(4)
...
t.createObjectURL=b},function(e,t,r){},function(module,exports,__w_pdfjs_require__){"use strict"
...
var _util=__w_pdfjs_require__(1),_display_utils=__w_pdfjs_require__(4),_font_loader=__w_pdfjs_require__(5),_api_compatibility=__w_pdfjs_require__(6),_canvas=__w_pdfjs_require__(8),_worker_options=__w_pdfjs_require__(10),_is_node=__w_pdfjs_require__(7),_message_handler=__w_pdfjs_require__(11),_metadata=__w_pdfjs_require__(12),_transport_stream=__w_pdfjs_require__(14),_webgl=__w_pdfjs_require__(15)
...
let n=null,i=null
for(const l in r)if("url"!==l||"undefined"==typeof window)if("range"!==l)if("worker"!==l)if("data"!==l||r[l]instanceof Uint8Array)s[l]=r[l]
else{const e=r[l]
if("string"==typeof e)s[l]=(0,_util.stringToBytes)(e)
...
s[l]=new Uint8Array(e)}else s[l]=new Uint8Array(e)}else i=r[l]
else n=r[l]
else s[l]=new URL(r[l],window.location).href
...
i=e.port?PDFWorker.fromPort(e):new PDFWorker(e),t._worker=i}const o=t.docId
return i.promise.then((function(){if(t.destroyed)throw new Error("Loading aborted")
return _fetchDocument(i,s,n,o).then((function(e){if(t.destroyed)throw new Error("Loading aborted")
let r
n?r=new _transport_stream.PDFDataTransportStream({length:s.length,initialData:s.initialData,progressiveDone:s.progressiveDone,disableRange:s.disableRange,disableStream:s.disableStream},n):s.data||(r=createPDFNetworkStream({url:s.url,length:s.length,httpHeaders:s.httpHeaders,withCredentials:s.withCredentials,rangeChunkSize:s.rangeChunkSize,disableRange:s.disableRange,disableStream:s.disableStream}))
...
return(this._transport?this._transport.destroy():Promise.resolve()).then(()=>{this._transport=null,this._worker&&(this._worker.destroy(),this._worker=null)})}then(e,t){throw new Error("Removed API method: PDFDocumentLoadingTask.then, use the `promise` getter instead.")}}}()
...
const f=g.task
return h.displayReadyCapability.promise.then(e=>{this.pendingCleanup?p():(this._stats&&this._stats.time("Rendering"),g.initializeGraphics(e),g.operatorListChanged())}).catch(p),f}getOperatorList(){this.intentStates.oplist||(this.intentStates.oplist=Object.create(null))
const e=this.intentStates.oplist
let t
return e.opListReadCapability||(t={},t.operatorListChanged=function(){if(e.operatorList.lastChunk){e.opListReadCapability.resolve(e.operatorList)
...
this.fontLoader.bind(a).then(()=>{this.commonObjs.resolve(r,a)},t=>{e.sendWithPromise("FontFallback",{id:r}).finally(()=>{this.commonObjs.resolve(r,a)})})
break
case"FontPath":case"FontType3Res":this.commonObjs.resolve(r,n)
break
...
if(!i.objs.has(t))switch(s){case"JpegStream":return new Promise((e,t)=>{const r=new Image
r.onload=function(){e(r)},r.onerror=function(){t(new Error("Error during JPEG image loading")),(0,_display_utils.releaseImageResources)(r)},r.src=n}).then(e=>{i.objs.resolve(t,e)})
case"Image":i.objs.resolve(t,n)
const e=8e6
n&&"data"in n&&n.data.length>e&&(i.cleanupAfterRender=!0)
break
default:throw new Error("Got unknown object type "+s)}}),e.on("DocProgress",e=>{this.destroyed||t.onProgress&&t.onProgress({loaded:e.loaded,total:e.total})}),e.on("UnsupportedFeature",this._onUnsupportedFeature.bind(this)),e.on("JpegDecode",e=>{if(this.destroyed)return Promise.reject(new Error("Worker was destroyed"))
if("undefined"==typeof document)return Promise.reject(new Error('"document" is not defined.'))
const[t,r]=e
return 3!==r&&1!==r?Promise.reject(new Error("Only 3 components or 1 component can be returned")):new Promise((function(e,s){const n=new Image
n.onload=function(){const{width:t,height:s}=n,i=t*s,a=4*i,o=new Uint8ClampedArray(i*r)
let l=document.createElement("canvas")
l.width=t,l.height=s
let c=l.getContext("2d")
c.drawImage(n,0,0)
const h=c.getImageData(0,0,t,s).data
if(3===r)for(let e=0,r=0;e<a;e+=4,r+=3)o[r]=h[e],o[r+1]=h[e+1],o[r+2]=h[e+2]
else if(1===r)for(let e=0,r=0;e<a;e+=4,r++)o[r]=h[e]
e({data:o,width:t,height:s}),(0,_display_utils.releaseImageResources)(n),l.width=0,l.height=0,l=null,c=null},n.onerror=function(){s(new Error("JpegDecode failed to load image")),(0,_display_utils.releaseImageResources)(n)},n.src=t}))}),e.on("FetchBuiltInCMap",(e,t)=>{if(this.destroyed)return void t.error(new Error("Worker was destroyed"))
let r=!1
...
r.resolved=!0,r.data=t,r.capability.resolve(t)}clear(){for(const e in this._objs){const{data:t}=this._objs[e]
"undefined"!=typeof Image&&t instanceof Image&&(0,_display_utils.releaseImageResources)(t)}this._objs=Object.create(null)}}class RenderTask{constructor(e){this._internalRenderTask=e,this.onContinue=null}get promise(){return this._internalRenderTask.capability.promise}cancel(){this._internalRenderTask.cancel()}then(e,t){throw new Error("Removed API method: RenderTask.then, use the `promise` getter instead.")}}const InternalRenderTask=function(){const e=new WeakSet
...
this.gfx=new _canvas.CanvasGraphics(r,this.commonObjs,this.objs,this.canvasFactory,this.webGLContext,i),this.gfx.beginDrawing({transform:n,viewport:s,transparency:t,background:a}),this.operatorListIdx=0,this.graphicsReady=!0,this.graphicsReadyCallback&&this.graphicsReadyCallback()}cancel(t=null){this.running=!1,this.cancelled=!0,this.gfx&&this.gfx.endDrawing(),this._canvas&&e.delete(this._canvas),this.callback(t||new _display_utils.RenderingCancelledException("Rendering cancelled, page "+(this._pageIndex+1),"canvas"))}operatorListChanged(){this.graphicsReady?(this.stepper&&this.stepper.updateOperatorList(this.operatorList),this.running||this._continue()):this.graphicsReadyCallback||(this.graphicsReadyCallback=this._continueBound)}_continue(){this.running=!0,this.cancelled||(this.task.onContinue?this.task.onContinue(this._scheduleNextBound):this._scheduleNext())}_scheduleNext(){this._useRequestAnimationFrame?window.requestAnimationFrame(()=>{this._nextBound().catch(this.cancel.bind(this))}):Promise.resolve().then(this._nextBound).catch(this.cancel.bind(this))}async _next(){this.cancelled||(this.operatorListIdx=this.gfx.executeOperatorList(this.operatorList,this.operatorListIdx,this._continueBound,this.stepper),this.operatorListIdx===this.operatorList.argsArray.length&&(this.running=!1,this.operatorList.lastChunk&&(this.gfx.endDrawing(),this._canvas&&e.delete(this._canvas),this.callback())))}}}(),version="2.4.456"
exports.version=version
const build="228a591c"
exports.build=build},function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.addLinkAttributes=function(e,{url:t,target:r,rel:n,enabled:i=!0}={}){(0,s.assert)(t&&"string"==typeof t,'addLinkAttributes: A valid "url" parameter must provided.')
const a=(0,s.removeNullCharacters)(t)
i?e.href=e.title=a:(e.href="",e.title="Disabled: "+a,e.onclick=()=>!1)
let l=""
switch(r){case o.NONE:break
case o.SELF:l="_self"
break
case o.BLANK:l="_blank"
break
case o.PARENT:l="_parent"
break
case o.TOP:l="_top"}e.target=l,e.rel="string"==typeof n?n:"noopener noreferrer nofollow"},t.getFilenameFromUrl=function(e){const t=e.indexOf("#"),r=e.indexOf("?"),s=Math.min(t>0?t:e.length,r>0?r:e.length)
return e.substring(e.lastIndexOf("/",s)+1,s)},t.isFetchSupported=l,t.isValidFetchUrl=c,t.loadScript=function(e){return new Promise((t,r)=>{const s=document.createElement("script")
s.src=e,s.onload=t,s.onerror=function(){r(new Error("Cannot load script at: "+s.src))},(document.head||document.documentElement).appendChild(s)})},t.deprecated=function(e){console.log("Deprecated API usage: "+e)},t.releaseImageResources=function(e){(0,s.assert)(e instanceof Image,"Invalid `img` parameter.")
const t=e.src
...
return l()&&c(t,document.baseURI)?fetch(t).then(async e=>{if(!e.ok)throw new Error(e.statusText)
let t
...
return r.setAttribute("version","1.1"),r.setAttribute("width",e+"px"),r.setAttribute("height",t+"px"),r.setAttribute("preserveAspectRatio","none"),r.setAttribute("viewBox","0 0 "+e+" "+t),r}createElement(e){return(0,s.assert)("string"==typeof e,"Invalid SVG element type"),document.createElementNS(n,e)}}
class i{constructor({viewBox:e,scale:t,rotation:r,offsetX:s=0,offsetY:n=0,dontFlip:i=!1}){this.viewBox=e,this.scale=t,this.rotation=r,this.offsetX=s,this.offsetY=n
...
break
default:l=1,c=0,h=0,d=-1}i&&(h=-h,d=-d),0===l?(u=Math.abs(o-e[1])*t+s,p=Math.abs(a-e[0])*t+n,g=Math.abs(e[3]-e[1])*t,f=Math.abs(e[2]-e[0])*t):(u=Math.abs(a-e[0])*t+s,p=Math.abs(o-e[1])*t+n,g=Math.abs(e[2]-e[0])*t,f=Math.abs(e[3]-e[1])*t),this.transform=[l*t,c*t,h*t,d*t,u-l*t*a-h*t*o,p-c*t*a-d*t*o],this.width=g,this.height=f}clone({scale:e=this.scale,rotation:t=this.rotation,offsetX:r=this.offsetX,offsetY:s=this.offsetY,dontFlip:n=!1}={}){return new i({viewBox:this.viewBox.slice(),scale:e,rotation:t,offsetX:r,offsetY:s,dontFlip:n})}convertToViewportPoint(e,t){return s.Util.applyTransform([e,t],this.transform)}convertToViewportRectangle(e){const t=s.Util.applyTransform([e[0],e[1]],this.transform),r=s.Util.applyTransform([e[2],e[3]],this.transform)
return[t[0],t[1],r[0],r[1]]}convertToPdfPoint(e,t){return s.Util.applyInverseTransform([e,t],this.transform)}}t.PageViewport=i
class a extends s.BaseException{constructor(e,t){super(e),this.type=t}}t.RenderingCancelledException=a
const o={NONE:0,SELF:1,BLANK:2,PARENT:3,TOP:4}
t.LinkTarget=o
function l(){return"undefined"!=typeof fetch&&"undefined"!=typeof Response&&"body"in Response.prototype&&"undefined"!=typeof ReadableStream}function c(e,t){try{const{protocol:r}=t?new URL(e,t):new URL(e)
return"http:"===r||"https:"===r}catch(r){return!1}}let h
...
return u=u>=0&&u<=59?u:0,"-"===c?(a+=d,o+=u):"+"===c&&(a-=d,o-=u),new Date(Date.UTC(r,n,i,a,o,l))}}},function(e,t,r){"use strict"
...
try{await t.loaded}catch(r){throw this._onUnsupportedFeature({featureId:s.UNSUPPORTED_FEATURES.font}),(0,s.warn)(`Failed to load font '${t.family}': '${r}'.`),e.disableFontFace=!0,r}}return}const t=e.createFontFaceRule()
...
for(m.style.visibility="hidden",m.style.width=m.style.height="10px",m.style.position="absolute",m.style.top=m.style.left="0px",a=0,o=f.length;a<o;++a){const e=document.createElement("span")
e.textContent="Hi",e.style.fontFamily=f[a],m.appendChild(e)}document.body.appendChild(m),function e(t,r){if(h++,h>30)return(0,s.warn)("Load test font never loaded."),void r()
c.font="30px "+t,c.fillText(".",0,20),c.getImageData(0,0,1,1).data[3]>0?r():setTimeout(e.bind(null,t,r))}(d,(function(){document.body.removeChild(m),r.complete()}))}}
...
return this._onUnsupportedFeature&&this._onUnsupportedFeature({featureId:s.UNSUPPORTED_FEATURES.font}),(0,s.warn)(`getPathGenerator - ignoring character: "${i}".`),this.compiledGlyphs[t]=function(e,t){}}if(this.isEvalSupported&&s.IsEvalSupportedCached.value){let e,s=""
...
{const{isNodeJS:e}=r(7),t="undefined"!=typeof navigator&&navigator.userAgent||"",n=/Trident/.test(t),i=/CriOS/.test(t);(n||i)&&(s.disableCreateObjectURL=!0),e&&(s.disableFontFace=!0,s.nativeImageDecoderSupport="none")}t.apiCompatibilityParams=Object.freeze(s)},function(e,t,r){"use strict"
...
this._transformMatrix=[s[0]*t+s[2]*r,s[1]*t+s[3]*r,s[0]*-r+s[2]*t,s[1]*-r+s[3]*t,s[4],s[5]],this._originalRotate(e)})}var a=function(){function e(e){this.canvasFactory=e,this.cache=Object.create(null)}return e.prototype={getCanvas:function(e,t,r,s){var n
return void 0!==this.cache[e]?(n=this.cache[e],this.canvasFactory.reset(n,t,r),n.context.setTransform(1,0,0,1,0,0)):(n=this.canvasFactory.create(t,r),this.cache[e]=n),s&&i(n.context),n},clear(){for(var e in this.cache){var t=this.cache[e]
this.canvasFactory.destroy(t),delete this.cache[e]}}},e}()
var o=function(){function e(){this.alphaIsShape=!1,this.fontSize=0,this.fontSizeScale=1,this.textMatrix=s.IDENTITY_MATRIX,this.textMatrixScale=1,this.fontMatrix=s.FONT_IDENTITY_MATRIX,this.leading=0,this.x=0,this.y=0,this.lineX=0,this.lineY=0,this.charSpacing=0,this.wordSpacing=0,this.textHScale=1,this.textRenderingMode=s.TextRenderingMode.FILL,this.textRise=0,this.fillColor="#000000",this.strokeColor="#000000",this.patternFill=!1,this.fillAlpha=1,this.strokeAlpha=1,this.lineWidth=1,this.activeSMask=null,this.resumeSMaskCtx=null}return e.prototype={clone:function(){return Object.create(this)},setCurrentPoint:function(e,t){this.x=e,this.y=t}},e}(),l=function(){function e(e,t,r,s,n,l){this.ctx=e,this.current=new o,this.stateStack=[],this.pendingClip=null,this.pendingEOFill=!1,this.res=null,this.xobjs=null,this.commonObjs=t,this.objs=r,this.canvasFactory=s,this.webGLContext=n,this.imageLayer=l,this.groupStack=[],this.processingType3=null,this.baseTransform=null,this.baseTransformStack=[],this.groupLevel=0,this.smaskStack=[],this.smaskCounter=0,this.tempSMask=null,this.cachedCanvases=new a(this.canvasFactory),e&&i(e),this._cachedGetSinglePixelWidth=null}function t(e,t){if("undefined"!=typeof ImageData&&t instanceof ImageData)e.putImageData(t,0,0)
else{var r,n,i,a,o,l=t.height,c=t.width,h=l%16,d=(l-h)/16,u=0===h?d:d+1,p=e.createImageData(c,16),g=0,f=t.data,m=p.data
if(t.kind===s.ImageKind.GRAYSCALE_1BPP){var A=f.byteLength,b=new Uint32Array(m.buffer,0,m.byteLength>>2),_=b.length,y=c+7>>3,v=4294967295,S=s.IsLittleEndianCached.value?4278190080:255
for(n=0;n<u;n++){for(a=n<d?16:h,r=0,i=0;i<a;i++){for(var x=A-g,C=0,k=x>y?c:8*x-7,w=-8&k,R=0,P=0;C<w;C+=8)P=f[g++],b[r++]=128&P?v:S,b[r++]=64&P?v:S,b[r++]=32&P?v:S,b[r++]=16&P?v:S,b[r++]=8&P?v:S,b[r++]=4&P?v:S,b[r++]=2&P?v:S,b[r++]=1&P?v:S
for(;C<k;C++)0===R&&(P=f[g++],R=128),b[r++]=P&R?v:S,R>>=1}for(;r<_;)b[r++]=0
e.putImageData(p,0,16*n)}}else if(t.kind===s.ImageKind.RGBA_32BPP){for(i=0,o=16*c*4,n=0;n<d;n++)m.set(f.subarray(g,g+o)),g+=o,e.putImageData(p,0,i),i+=16
n<u&&(o=c*h*4,m.set(f.subarray(g,g+o)),e.putImageData(p,0,i))}else{if(t.kind!==s.ImageKind.RGB_24BPP)throw new Error("bad image kind: "+t.kind)
for(o=c*(a=16),n=0;n<u;n++){for(n>=d&&(o=c*(a=h)),r=0,i=o;i--;)m[r++]=f[g++],m[r++]=f[g++],m[r++]=f[g++],m[r++]=255
e.putImageData(p,0,16*n)}}}}function r(e,t){for(var r=t.height,s=t.width,n=r%16,i=(r-n)/16,a=0===n?i:i+1,o=e.createImageData(s,16),l=0,c=t.data,h=o.data,d=0;d<a;d++){for(var u=d<i?16:n,p=3,g=0;g<u;g++)for(var f=0,m=0;m<s;m++){if(!f){var A=c[l++]
f=128}h[p]=A&f?0:255,p+=4,f>>=1}e.putImageData(o,0,16*d)}}function l(e,t){for(var r=["strokeStyle","fillStyle","fillRule","globalAlpha","lineWidth","lineCap","lineJoin","miterLimit","globalCompositeOperation","font"],s=0,n=r.length;s<n;s++){var i=r[s]
void 0!==e[i]&&(t[i]=e[i])}void 0!==e.setLineDash&&(t.setLineDash(e.getLineDash()),t.lineDashOffset=e.lineDashOffset)}function c(e){e.strokeStyle="#000000",e.fillStyle="#000000",e.fillRule="nonzero",e.globalAlpha=1,e.lineWidth=1,e.lineCap="butt",e.lineJoin="miter",e.miterLimit=10,e.globalCompositeOperation="source-over",e.font="10px sans-serif",void 0!==e.setLineDash&&(e.setLineDash([]),e.lineDashOffset=0)}function h(e,t,r,s){for(var n=e.length,i=3;i<n;i+=4){var a=e[i]
if(0===a)e[i-3]=t,e[i-2]=r,e[i-1]=s
else if(a<255){var o=255-a
e[i-3]=e[i-3]*a+t*o>>8,e[i-2]=e[i-2]*a+r*o>>8,e[i-1]=e[i-1]*a+s*o>>8}}}function d(e,t,r){for(var s=e.length,n=3;n<s;n+=4){var i=r?r[e[n]]:e[n]
t[n]=t[n]*i*(1/255)|0}}function u(e,t,r){for(var s=e.length,n=3;n<s;n+=4){var i=77*e[n-3]+152*e[n-2]+28*e[n-1]
t[n]=r?t[n]*r[i>>8]>>8:t[n]*i>>16}}function p(e,t,r,s){var n=t.canvas,i=t.context
...
return e.setTransform(1,0,0,1,0,0),void e.drawImage(i,t.offsetX,t.offsetY)}(function(e,t,r,s,n,i,a){var o,l=!!i,c=l?i[0]:0,p=l?i[1]:0,g=l?i[2]:0
o="Luminosity"===n?u:d
for(var f=Math.min(s,Math.ceil(1048576/r)),m=0;m<s;m+=f){var A=Math.min(f,s-m),b=e.getImageData(0,m,r,A),_=t.getImageData(0,m,r,A)
l&&h(b.data,c,p,g),o(b.data,_.data,a),e.putImageData(_,0,m)}})(i,r,n.width,n.height,t.subtype,a,t.transferMap),e.drawImage(n,0,0)}var g=["butt","round","square"],f=["miter","round","bevel"],m={},A={}
for(var b in e.prototype={beginDrawing({transform:e,viewport:t,transparency:r=!1,background:s=null}){var n=this.ctx.canvas.width,i=this.ctx.canvas.height
...
this.ctx.save()
var o=n.context
o.scale(1/e.scaleX,1/e.scaleY),o.translate(-e.offsetX,-e.offsetY),o.transform.apply(o,a),e.startTransformInverse=o.mozCurrentTransformInverse,l(i,o),this.ctx=o,this.setGState([["BM","source-over"],["ca",1],["CA",1]]),this.groupStack.push(i),this.groupLevel++},suspendSMaskGroup:function(){var e=this.ctx
...
t.strokeStyle=r.getPattern(t,this),t.lineWidth=Math.max(.65*this.getSinglePixelWidth(),this.current.lineWidth*n),t.stroke(),t.restore()}else t.lineWidth=Math.max(.65*this.getSinglePixelWidth(),this.current.lineWidth),t.stroke()
...
var n=t.fontSize
if(0===n)return
var i=this.ctx,a=t.fontSizeScale,o=t.charSpacing,l=t.wordSpacing,c=t.fontDirection,h=t.textHScale*c,d=e.length,u=r.vertical,p=u?1:-1,g=r.defaultVMetrics,f=n*t.fontMatrix[0],m=t.textRenderingMode===s.TextRenderingMode.FILL&&!r.disableFontFace&&!t.patternFill
let A
...
if(0===_||0===b){var y=t.textRenderingMode&s.TextRenderingMode.FILL_STROKE_MASK
y!==s.TextRenderingMode.STROKE&&y!==s.TextRenderingMode.FILL_STROKE||(this._cachedGetSinglePixelWidth=null,b=.65*this.getSinglePixelWidth())}else b/=_
1!==a&&(i.scale(a,a),b/=a),i.lineWidth=b
var v,S=0
for(v=0;v<d;++v){var x=e[v]
if((0,s.isNum)(x))S+=p*x*n/1e3
else{var C,k,w,R,P,T,E,F=!1,L=(x.isSpace?l:0)+o,I=x.fontChar,M=x.accent,D=x.width
if(u)P=x.vmetric||g,T=-(T=x.vmetric?P[1]:.5*D)*f,E=P[2]*f,D=P?-P[0]:D,C=T/a,k=(S+E)/a
else C=S/a,k=0
if(r.remeasure&&D>0){var O=1e3*i.measureText(I).width/n*a
if(D<O&&this.isFontSubpixelAAEnabled){var N=D/O
F=!0,i.save(),i.scale(N,1),C/=N}else D!==O&&(C+=(D-O)/2e3*n/a)}(x.isInFont||r.missingFile)&&(m&&!M?i.fillText(I,C,k):(this.paintChar(I,C,k,A),M&&(w=C+M.offset.x/a,R=k-M.offset.y/a,this.paintChar(M.fontChar,w,R,A)))),S+=u?D*f-L*c:D*f+L*c,F&&i.restore()}}u?t.y-=S:t.x+=S*h,i.restore()},showType3Text:function(e){var t,r,n,i,a=this.ctx,o=this.current,l=o.font,c=o.fontSize,h=o.fontDirection,d=l.vertical?1:-1,u=o.charSpacing,p=o.wordSpacing,g=o.textHScale*h,f=o.fontMatrix||s.FONT_IDENTITY_MATRIX,m=e.length
...
var n=s.Util.getAxialAlignedBoundingBox(e.bbox,t.mozCurrentTransform),i=[0,0,t.canvas.width,t.canvas.height]
n=s.Util.intersect(n,i)||[0,0,0,0]
var a=Math.floor(n[0]),o=Math.floor(n[1]),c=Math.max(Math.ceil(n[2])-a,1),h=Math.max(Math.ceil(n[3])-o,1),d=1,u=1
c>4096&&(d=c/4096,c=4096),h>4096&&(u=h/4096,h=4096)
var p="groupAt"+this.groupLevel
e.smask&&(p+="_smask_"+this.smaskCounter++%2)
var g=this.cachedCanvases.getCanvas(p,c,h,!0),f=g.context
f.scale(1/d,1/u),f.translate(-a,-o),f.transform.apply(f,r),e.smask?this.smaskStack.push({canvas:g.canvas,context:f,offsetX:a,offsetY:o,scaleX:d,scaleY:u,subtype:e.smask.subtype,backdrop:e.smask.backdrop,transferMap:e.smask.transferMap||null,startTransformInverse:null}):(t.setTransform(1,0,0,1,0,0),t.translate(a,o),t.scale(d,u)),l(t,f),this.ctx=f,this.setGState([["BM","source-over"],["ca",1],["CA",1]]),this.groupStack.push(t),this.groupLevel++,this.current.activeSMask=null},endGroup:function(e){this.groupLevel--
var t=this.ctx
this.ctx=this.groupStack.pop(),void 0!==this.ctx.imageSmoothingEnabled?this.ctx.imageSmoothingEnabled=!1:this.ctx.mozImageSmoothingEnabled=!1,e.smask?this.tempSMask=this.smaskStack.pop():this.ctx.drawImage(t.canvas,0,0),this.restore()},beginAnnotations:function(){this.save(),this.baseTransform&&this.ctx.setTransform.apply(this.ctx,this.baseTransform)},endAnnotations:function(){this.restore()},beginAnnotation:function(e,t,r){if(this.save(),c(this.ctx),this.current=new o,Array.isArray(e)&&4===e.length){var s=e[2]-e[0],n=e[3]-e[1]
this.ctx.rect(e[0],e[1],s,n),this.clip(),this.endPath()}this.transform.apply(this,t),this.transform.apply(this,r)},endAnnotation:function(){this.restore()},paintJpegXObject:function(e,t,r){const n=this.processingType3?this.commonObjs.get(e):this.objs.get(e)
if(n){this.save()
var i=this.ctx
if(i.scale(1/t,-1/r),i.drawImage(n,0,0,n.width,n.height,0,-r,t,r),this.imageLayer){var a=i.mozCurrentTransformInverse,o=this.getCanvasPosition(0,0)
this.imageLayer.appendImage({objId:e,left:o[0],top:o[1],width:t/a[0],height:r/a[3]})}this.restore()}else(0,s.warn)("Dependent image isn't ready yet")},paintImageMaskXObject:function(e){var t=this.ctx,s=e.width,n=e.height,i=this.current.fillColor,a=this.current.patternFill,o=this.processingType3
...
if(y!==v){var S,x=[y%o,t],C=l[y],k=y
do{var w=b[C]
do{y+=w}while(!l[y])
5!==(S=l[y])&&10!==S?(C=S,l[y]=0):(C=S&51*C>>4,l[y]&=C>>2|C<<2),x.push(y%o),x.push(y/o|0),l[y]||--m}while(k!==y)
_.push(x),--t}}return function(e){e.save(),e.scale(1/i,-1/a),e.translate(0,-a),e.beginPath()
for(var t=0,r=_.length;t<r;t++){var s=_[t]
e.moveTo(s[0],s[1])
for(var n=2,o=s.length;n<o;n+=2)e.lineTo(s[n],s[n+1])}e.fill(),e.beginPath(),e.restore()}}({data:e.data,width:s,height:n}):null),o&&o.compiled)o.compiled(t)
...
t?this.paintInlineImageXObject(t):(0,s.warn)("Dependent image isn't ready yet")},paintImageXObjectRepeat:function(e,t,r,n){const i=this.processingType3?this.commonObjs.get(e):this.objs.get(e)
...
this.pendingClip&&(this.pendingClip===A?e.clip("evenodd"):e.clip(),this.pendingClip=null),e.beginPath()},getSinglePixelWidth(e){if(null===this._cachedGetSinglePixelWidth){const e=this.ctx.mozCurrentTransformInverse
...
return[r[0]*e+r[2]*t+r[4],r[1]*e+r[3]*t+r[5]]}},s.OPS)e.prototype[s.OPS[b]]=e.prototype[b]
return e}()
...
if(!(g>=b))for(var _,y,v,S,x,C,k,w,R=h[i],P=h[i+1],T=h[i+2],E=h[a],F=h[a+1],L=h[a+2],I=h[o],M=h[o+1],D=h[o+2],O=Math.round(g),N=Math.round(b),j=O;j<=N;j++){if(j<m){let e
e=j<g?0:g===m?1:(g-j)/(g-m),_=p-(p-f)*e,y=R-(R-E)*e,v=P-(P-F)*e,S=T-(T-L)*e}else{let e
e=j>b?1:m===b?0:(m-j)/(m-b),_=f-(f-A)*e,y=E-(E-I)*e,v=F-(F-M)*e,S=L-(L-D)*e}let e
e=j<g?0:j>b?1:(g-j)/(g-b),x=p-(p-A)*e,C=R-(R-I)*e,k=P-(P-M)*e,w=T-(T-D)*e
for(var U=Math.round(Math.min(_,x)),q=Math.round(Math.max(_,x)),W=u*j+4*U,G=U;G<=q;G++){let e=(_-G)/(_-x)
e<0?e=0:e>1&&(e=1),d[W++]=y-(y-C)*e|0,d[W++]=v-(v-k)*e|0,d[W++]=S-(S-w)*e|0,d[W++]=255}}}function t(t,r,s){var n,i,a=r.coords,o=r.colors
...
else{var C=(h=o.getCanvas("mesh",S,x,!1)).context,k=C.createImageData(A,b)
if(a){var w=k.data
for(d=0,u=w.length;d<u;d+=4)w[d]=a[0],w[d+1]=a[1],w[d+2]=a[2],w[d+3]=255}for(d=0;d<i.length;d++)t(k,i[d],v)
C.putImageData(k,2,2),c=h.canvas}return{canvas:c,offsetX:p-2*_,offsetY:g-2*y,scaleX:_,scaleY:y}}}()
...
var s=r(1)
t.PDFDataTransportStream=class{constructor(e,t){(0,s.assert)(t),this._queuedChunks=[],this._progressiveDone=e.progressiveDone||!1
...
else{const r=this._rangeReaders.some((function(r){return r._begin===e.begin&&(r._enqueue(t),!0)}));(0,s.assert)(r)}}get _progressiveDataLength(){return this._fullRequestReader?this._fullRequestReader._loaded:0}_onProgress(e){if(void 0===e.total){const t=this._rangeReaders[0]
...
t>=0&&this._rangeReaders.splice(t,1)}getFullReader(){(0,s.assert)(!this._fullRequestReader)
...
for(f=0,m=h.length;f<m;f++){var k=h[f],w=k.coords,R=k.colors
switch(k.type){case"lattice":var P=k.verticesPerRow
A=w.length/P|0
for(var T=1;T<A;T++)for(var E=T*P+1,F=1;F<P;F++,E++){_[x]=v[w[E-P-1]],_[x+1]=v[w[E-P-1]+1],_[x+2]=v[w[E-P]],_[x+3]=v[w[E-P]+1],_[x+4]=v[w[E-1]],_[x+5]=v[w[E-1]+1],y[C]=S[R[E-P-1]],y[C+1]=S[R[E-P-1]+1],y[C+2]=S[R[E-P-1]+2],y[C+3]=S[R[E-P]],y[C+4]=S[R[E-P]+1],y[C+5]=S[R[E-P]+2],y[C+6]=S[R[E-1]],y[C+7]=S[R[E-1]+1],y[C+8]=S[R[E-1]+2],_[x+6]=_[x+2],_[x+7]=_[x+3],_[x+8]=_[x+4],_[x+9]=_[x+5],_[x+10]=v[w[E]],_[x+11]=v[w[E]+1],y[C+9]=y[C+3],y[C+10]=y[C+4],y[C+11]=y[C+5],y[C+12]=y[C+6],y[C+13]=y[C+7],y[C+14]=y[C+8],y[C+15]=S[R[E]],y[C+16]=S[R[E]+1],y[C+17]=S[R[E]+2]
x+=12,C+=18}break
case"triangles":for(var L=0,I=w.length;L<I;L++)_[x]=v[w[L]],_[x+1]=v[w[L]+1],y[C]=S[R[L]],y[C+1]=S[R[L]+1],y[C+2]=S[R[L]+2],x+=2,C+=3}}l?g.clearColor(l[0]/255,l[1]/255,l[2]/255,1):g.clearColor(0,0,0,0),g.clear(g.COLOR_BUFFER_BIT)
...
return g.bindBuffer(g.ARRAY_BUFFER,D),g.bufferData(g.ARRAY_BUFFER,y,g.STATIC_DRAW),g.enableVertexAttribArray(u.colorLocation),g.vertexAttribPointer(u.colorLocation,3,g.UNSIGNED_BYTE,!1,0,0),g.uniform2f(u.scaleLocation,d.scaleX,d.scaleY),g.uniform2f(u.offsetLocation,d.offsetX,d.offsetY),g.drawArrays(g.TRIANGLES,0,b),g.flush(),g.deleteBuffer(M),g.deleteBuffer(D),p},cleanup(){l&&l.canvas&&(l.canvas.width=0,l.canvas.height=0),c&&c.canvas&&(c.canvas.width=0,c.canvas.height=0),l=null,c=null}}}()},function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.renderTextLayer=void 0
var s=r(1),n=function(){var e=/\S/
...
var A,b,_=(h.vertical?r.height:r.width)*t._viewport.scale,y=d
0!==c?(A=[f,m,-m,f,p,g],b=s.Util.getAxialAlignedBoundingBox([0,0,_,y],A)):b=[p,g,p+_,g+y],t._bounds.push({left:b[0],top:b[1],right:b[2],bottom:b[3],div:a,size:[_,y],m:A})}}function r(e){if(!e._canceled){var t=e._textDivs,r=e._capability,s=t.length
if(s>1e5)return e._renderingDone=!0,void r.resolve()
if(!e._textContentStream)for(var n=0;n<s;n++)e._layoutText(t[n])
e._renderingDone=!0,r.resolve()}}function n(e){for(var t=e._bounds,r=e._viewport,n=function(e,t,r){var s=r.map((function(e,t){return{x1:e.left,y1:e.top,x2:e.right,y2:e.bottom,index:t,x1New:void 0,x2New:void 0}}))
i(e,s)
...
a.x1=t.top,a.y1=e-i.right,a.x2=t.bottom,a.y2=e-i.left,a.index=r,a.x1New=void 0,a.x2New=void 0})),i(t,s),s.forEach((function(e){var t=e.index
n[t].top=e.x1New,n[t].bottom=e.x2New})),n}(r.width,r.height,t),a=0;a<n.length;a++){var o=t[a].div,l=e._textDivProperties.get(o)
if(0!==l.angle){var c=n[a],h=t[a],d=h.m,u=d[0],p=d[1],g=[[0,0],[0,h.size[1]],[h.size[0],0],h.size],f=new Float64Array(64)
g.forEach((function(e,t){var r=s.Util.applyTransform(e,d)
...
var m=function(e,t,r){for(var s=0,n=0;n<r;n++){var i=e[t++]
i>0&&(s=s?Math.min(i,s):i)}return s},A=1+Math.min(Math.abs(u),Math.abs(p))
l.paddingLeft=m(f,32,16)/A,l.paddingTop=m(f,48,16)/A,l.paddingRight=m(f,0,16)/A,l.paddingBottom=m(f,16,16)/A,e._textDivProperties.set(o,l)}else l.paddingLeft=t[a].left-n[a].left,l.paddingTop=t[a].top-n[a].top,l.paddingRight=n[a].right-t[a].right,l.paddingBottom=n[a].bottom-t[a].bottom,e._textDivProperties.set(o,l)}}function i(e,t){t.sort((function(e,t){return e.x1-t.x1||e.index-t.index}))
...
const t=[],r=[]
for(var s=0,i=this._textDivs.length;s<i;s++){const n=this._textDivs[s],i=this._textDivProperties.get(n)
...
case n.AnnotationType.HIGHLIGHT:return new k(e)
case n.AnnotationType.UNDERLINE:return new w(e)
case n.AnnotationType.SQUIGGLY:return new R(e)
case n.AnnotationType.STRIKEOUT:return new P(e)
...
let t=null
if(this.renderInteractiveForms){if(this.data.multiLine?(t=document.createElement("textarea"),t.textContent=this.data.fieldValue):(t=document.createElement("input"),t.type="text",t.setAttribute("value",this.data.fieldValue)),t.disabled=this.data.readOnly,null!==this.data.maxLen&&(t.maxLength=this.data.maxLen),this.data.comb){const e=(this.data.rect[2]-this.data.rect[0])/this.data.maxLen
...
return e.disabled=this.data.readOnly,e.type="checkbox",this.data.fieldValue&&"Off"!==this.data.fieldValue&&e.setAttribute("checked",!0),this.container.appendChild(e),this.container}}class u extends c{constructor(e){super(e,e.renderInteractiveForms)}render(){this.container.className="buttonWidgetAnnotation radioButton"
const e=document.createElement("input")
...
const r=Math.ceil(t/65535),s=new Uint8Array(2+t+5*r+4)
let n=0
s[n++]=120,s[n++]=156
let i=0
...
const a=function(e,t,r){let s=1,n=0
for(let i=t;i<r;++i)s=(s+(255&e[i]))%65521,n=(n+s)%65521
return n<<16|s}(e,0,e.length)
return s[n++]=a>>24&255,s[n++]=a>>16&255,s[n++]=a>>8&255,s[n++]=255&a,s}function a(t,a,o,l){const c=t.width,h=t.height
let d,u,p
const g=t.data
...
break
case s.OPS.paintJpegXObject:this.paintJpegXObject(n[0],n[1],n[2])
break
...
e.x=e.lineX=0,e.y=e.lineY=0,e.textMatrix=s.IDENTITY_MATRIX,e.lineMatrix=s.IDENTITY_MATRIX,e.textMatrixScale=1,e.tspan=this.svgFactory.createElement("svg:tspan"),e.txtElement=this.svgFactory.createElement("svg:text"),e.txtgrp=this.svgFactory.createElement("svg:g"),e.xcoords=[]}moveText(e,t){const r=this.current
r.x=r.lineX+=e,r.y=r.lineY+=t,r.xcoords=[],r.tspan=this.svgFactory.createElement("svg:tspan"),r.tspan.setAttributeNS(null,"font-family",r.fontFamily),r.tspan.setAttributeNS(null,"font-size",o(r.fontSize)+"px"),r.tspan.setAttributeNS(null,"y",o(-r.y))}showText(t){const n=this.current,i=n.font,a=n.fontSize
if(0===a)return
const c=n.charSpacing,h=n.wordSpacing,d=n.fontDirection,u=n.textHScale*d,p=i.vertical,g=a*n.fontMatrix[0]
let f=0
for(const e of t){if(null===e){f+=d*h
continue}if((0,s.isNum)(e)){f+=-e*a*.001
continue}const t=e.width,r=e.fontChar,o=t*g+((e.isSpace?h:0)+c)*d
...
this._setStrokeAttributes(n.tspan,e)}let A=n.textMatrix
0!==n.textRise&&(A=A.slice(),A[5]+=n.textRise),n.txtElement.setAttributeNS(null,"transform",`${l(A)} scale(${o(u)}, -1)`),n.txtElement.setAttributeNS(r,"xml:space","preserve"),n.txtElement.appendChild(n.tspan),n.txtgrp.appendChild(n.txtElement),this._ensureTransformGroup().appendChild(n.txtElement)}setLeadingMoveText(e,t){this.setLeading(-t),this.moveText(e,t)}addFontStyle(e){this.cssStyle||(this.cssStyle=this.svgFactory.createElement("svg:style"),this.cssStyle.setAttributeNS(null,"type","text/css"),this.defs.appendChild(this.cssStyle))
...
n<0?(n=-n,t.fontDirection=-1):t.fontDirection=1,t.fontSize=n,t.fontFamily=r.loadedName,t.fontWeight=i,t.fontStyle=a,t.tspan=this.svgFactory.createElement("svg:tspan"),t.tspan.setAttributeNS(null,"y",o(-t.y)),t.xcoords=[]}endText(){const e=this.current
...
const x=this.svg,C=this.transformMatrix,k=this.current.fillColor,w=this.current.strokeColor,R=this.svgFactory.create(f-p,A-g)
...
e.setAttributeNS(null,"x","0"),e.setAttributeNS(null,"y","0"),e.setAttributeNS(null,"width","1px"),e.setAttributeNS(null,"height","1px"),e.setAttributeNS(null,"fill",this.current.fillColor),this._ensureTransformGroup().appendChild(e)}paintJpegXObject(e,t,r){const s=this.objs.get(e),n=this.svgFactory.createElement("svg:image")
n.setAttributeNS(c,"xlink:href",s.src),n.setAttributeNS(null,"width",o(t)),n.setAttributeNS(null,"height",o(r)),n.setAttributeNS(null,"x","0"),n.setAttributeNS(null,"y",o(-r)),n.setAttributeNS(null,"transform",`scale(${o(1/t)} ${o(-1/r)})`),this._ensureTransformGroup().appendChild(n)}paintImageXObject(e){const t=this.objs.get(e)
...
var s=r(1),n=r(21)},function(e,t,r){"use strict"
...
t>=0&&this._rangeRequestReaders.splice(t,1)}getFullReader(){return(0,s.assert)(!this._fullRequestReader),this._fullRequestReader=new a(this._manager,this._source),this._fullRequestReader}getRangeReader(e,t){const r=new o(this._manager,e,t)
