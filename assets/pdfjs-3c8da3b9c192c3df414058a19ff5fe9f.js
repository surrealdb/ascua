...
var s=r(1),n=r(5),i=r(2),a=r(19),o=r(9),l=r(12),c=r(21),h=r(22)
{const{isNodeJS:e}=r(4)
if(e){const e=r(23).PDFNodeStream;(0,n.setPDFNetworkStreamFactory)((t=>new e(t)))}else{const e=r(26).PDFNetworkStream
let t;(0,s.isFetchSupported)()&&(t=r(27).PDFFetchStream),(0,n.setPDFNetworkStreamFactory)((r=>t&&(0,s.isValidFetchUrl)(r.url)?new t(r):new e(r)))}}},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.addLinkAttributes=function(e,{url:t,target:r,rel:i,enabled:a=!0}={}){(0,s.assert)(t&&"string"==typeof t,'addLinkAttributes: A valid "url" parameter must provided.')
const o=(0,s.removeNullCharacters)(t)
a?e.href=e.title=o:(e.href="",e.title=`Disabled: ${o}`,e.onclick=()=>!1)
let l=""
switch(r){case h.NONE:break
case h.SELF:l="_self"
break
...
break
case h.TOP:l="_top"}e.target=l,e.rel="string"==typeof i?i:n},t.deprecated=function(e){console.log("Deprecated API usage: "+e)},t.getFilenameFromUrl=function(e){const t=e.indexOf("#"),r=e.indexOf("?"),s=Math.min(t>0?t:e.length,r>0?r:e.length)
return e.substring(e.lastIndexOf("/",s)+1,s)},t.isFetchSupported=d,t.isValidFetchUrl=u,t.loadScript=function(e,t=!1){return new Promise(((r,s)=>{const n=document.createElement("script")
n.src=e,n.onload=function(e){t&&n.remove(),r(e)},n.onerror=function(){s(new Error(`Cannot load script at: ${n.src}`))},(document.head||document.documentElement).appendChild(n)}))},t.StatTimer=t.RenderingCancelledException=t.PDFDateString=t.PageViewport=t.LinkTarget=t.DOMSVGFactory=t.DOMCMapReaderFactory=t.DOMCanvasFactory=t.DEFAULT_LINK_REL=t.BaseCMapReaderFactory=t.BaseCanvasFactory=void 0
var s=r(2)
const n="noopener noreferrer nofollow"
t.DEFAULT_LINK_REL=n
const i="http://www.w3.org/2000/svg"
class a{constructor(){this.constructor===a&&(0,s.unreachable)("Cannot initialize BaseCanvasFactory.")}create(e,t){(0,s.unreachable)("Abstract method `create` called.")}reset(e,t,r){if(!e.canvas)throw new Error("Canvas is not specified")
...
e.canvas.width=0,e.canvas.height=0,e.canvas=null,e.context=null}}t.BaseCanvasFactory=a
t.DOMCanvasFactory=class extends a{constructor({ownerDocument:e=globalThis.document}={}){super(),this._document=e}create(e,t){if(e<=0||t<=0)throw new Error("Invalid canvas size")
const r=this._document.createElement("canvas"),s=r.getContext("2d")
return r.width=e,r.height=t,{canvas:r,context:s}}}
...
return this._fetchData(t,r).catch((e=>{throw new Error(`Unable to load ${this.isCompressed?"binary ":""}CMap at: ${t}`)}))}_fetchData(e,t){(0,s.unreachable)("Abstract method `_fetchData` called.")}}t.BaseCMapReaderFactory=o
t.DOMCMapReaderFactory=class extends o{_fetchData(e,t){return d()&&u(e,document.baseURI)?fetch(e).then((async e=>{if(!e.ok)throw new Error(e.statusText)
let r
return r=this.isCompressed?new Uint8Array(await e.arrayBuffer()):(0,s.stringToBytes)(await e.text()),{cMapData:r,compressionType:t}})):new Promise(((r,n)=>{const i=new XMLHttpRequest
...
if(this.isCompressed&&i.response?e=new Uint8Array(i.response):!this.isCompressed&&i.responseText&&(e=(0,s.stringToBytes)(i.responseText)),e)return void r({cMapData:e,compressionType:t})}n(new Error(i.statusText))}},i.send(null)}))}}
...
class l{constructor({viewBox:e,scale:t,rotation:r,offsetX:s=0,offsetY:n=0,dontFlip:i=!1}){this.viewBox=e,this.scale=t,this.rotation=r,this.offsetX=s,this.offsetY=n
...
break
default:throw new Error("PageViewport: Invalid rotation, must be a multiple of 90 degrees.")}i&&(h=-h,d=-d),0===l?(u=Math.abs(o-e[1])*t+s,p=Math.abs(a-e[0])*t+n,g=Math.abs(e[3]-e[1])*t,f=Math.abs(e[2]-e[0])*t):(u=Math.abs(a-e[0])*t+s,p=Math.abs(o-e[1])*t+n,g=Math.abs(e[2]-e[0])*t,f=Math.abs(e[3]-e[1])*t),this.transform=[l*t,c*t,h*t,d*t,u-l*t*a-h*t*o,p-c*t*a-d*t*o],this.width=g,this.height=f}clone({scale:e=this.scale,rotation:t=this.rotation,offsetX:r=this.offsetX,offsetY:s=this.offsetY,dontFlip:n=!1}={}){return new l({viewBox:this.viewBox.slice(),scale:e,rotation:t,offsetX:r,offsetY:s,dontFlip:n})}convertToViewportPoint(e,t){return s.Util.applyTransform([e,t],this.transform)}convertToViewportRectangle(e){const t=s.Util.applyTransform([e[0],e[1]],this.transform),r=s.Util.applyTransform([e[2],e[3]],this.transform)
return[t[0],t[1],r[0],r[1]]}convertToPdfPoint(e,t){return s.Util.applyInverseTransform([e,t],this.transform)}}t.PageViewport=l
class c extends s.BaseException{constructor(e,t){super(e),this.type=t}}t.RenderingCancelledException=c
const h={NONE:0,SELF:1,BLANK:2,PARENT:3,TOP:4}
t.LinkTarget=h
function d(){return"undefined"!=typeof fetch&&"undefined"!=typeof Response&&"body"in Response.prototype&&"undefined"!=typeof ReadableStream}function u(e,t){try{const{protocol:r}=t?new URL(e,t):new URL(e)
return"http:"===r||"https:"===r}catch(r){return!1}}let p
...
return d=d>=0&&d<=59?d:0,"-"===c?(a+=h,o+=d):"+"===c&&(a-=h,o-=d),new Date(Date.UTC(r,n,i,a,o,l))}}},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.arrayByteLength=u,t.arraysToBytes=function(e){const t=e.length
...
let t=!1
return Object.defineProperty(e,"settled",{get:()=>t}),e.promise=new Promise((function(r,s){e.resolve=function(e){t=!0,r(e)},e.reject=function(e){t=!0,s(e)}})),e},t.createValidAbsoluteUrl=function(e,t){if(!e)return null
...
default:return!1}}(r))return r}catch(r){}return null},t.encodeToXmlString=function(e){const t=[]
let r=0
for(let s=0,n=e.length;s<n;s++){const n=e.codePointAt(s)
if(32<=n&&n<=126){const i=b[n]
i&&(r<s&&t.push(e.substring(r,s)),t.push(i),r=s+1)}else r<s&&t.push(e.substring(r,s)),t.push(`&#x${n.toString(16).toUpperCase()};`),n>55295&&(n<57344||n>65533)&&s++,r=s+1}if(0===t.length)return e
...
r.push(t?String.fromCharCode(t):e.charAt(s))}return r.join("")},t.stringToUTF16BEString=function(e){const t=["þÿ"]
for(let r=0,s=e.length;r<s;r++){const s=e.charCodeAt(r)
t.push(String.fromCharCode(s>>8&255)),t.push(String.fromCharCode(255&s))}return t.join("")},t.stringToUTF8String=function(e){return decodeURIComponent(escape(e))},t.unreachable=a
t.utf8StringToString=function(e){return unescape(encodeURIComponent(e))},t.warn=i,t.VerbosityLevel=t.Util=t.UNSUPPORTED_FEATURES=t.UnknownErrorException=t.UnexpectedResponseException=t.TextRenderingMode=t.StreamType=t.PermissionFlag=t.PasswordResponses=t.PasswordException=t.PageActionEventType=t.OPS=t.MissingPDFException=t.IsLittleEndianCached=t.IsEvalSupportedCached=t.InvalidPDFException=t.ImageKind=t.IDENTITY_MATRIX=t.FormatError=t.FontType=t.FONT_IDENTITY_MATRIX=t.DocumentActionEventType=t.createObjectURL=t.CMapCompressionType=t.BaseException=t.AnnotationType=t.AnnotationStateModelType=t.AnnotationReviewState=t.AnnotationReplyType=t.AnnotationMarkedState=t.AnnotationFlag=t.AnnotationFieldFlag=t.AnnotationBorderStyleType=t.AnnotationActionEventType=t.AbortException=void 0,r(3)
...
class m{static makeHexColor(e,t,r){return`#${f[e]}${f[t]}${f[r]}`}static transform(e,t){return[e[0]*t[0]+e[2]*t[1],e[1]*t[0]+e[3]*t[1],e[0]*t[2]+e[2]*t[3],e[1]*t[2]+e[3]*t[3],e[0]*t[4]+e[2]*t[5]+e[4],e[1]*t[4]+e[3]*t[5]+e[5]]}static applyTransform(e,t){return[e[0]*t[0]+e[1]*t[2]+t[4],e[0]*t[1]+e[1]*t[3]+t[5]]}static applyInverseTransform(e,t){const r=t[0]*t[3]-t[1]*t[2]
...
t.createObjectURL=_
const b={60:"&lt;",62:"&gt;",38:"&amp;",34:"&quot;",39:"&apos;"}},(e,t,r)=>{r(4)},(e,t)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.isNodeJS=void 0
...
t.isNodeJS=r},(__unused_webpack_module,exports,__w_pdfjs_require__)=>{Object.defineProperty(exports,"__esModule",{value:!0}),exports.getDocument=getDocument,exports.setPDFNetworkStreamFactory=setPDFNetworkStreamFactory,exports.version=exports.PDFWorker=exports.PDFPageProxy=exports.PDFDocumentProxy=exports.PDFDataRangeTransport=exports.LoopbackPort=exports.DefaultCMapReaderFactory=exports.DefaultCanvasFactory=exports.build=void 0
var _util=__w_pdfjs_require__(2),_display_utils=__w_pdfjs_require__(1),_font_loader=__w_pdfjs_require__(6),_node_utils=__w_pdfjs_require__(7),_annotation_storage=__w_pdfjs_require__(8),_api_compatibility=__w_pdfjs_require__(9),_canvas=__w_pdfjs_require__(10),_worker_options=__w_pdfjs_require__(12),_is_node=__w_pdfjs_require__(4),_message_handler=__w_pdfjs_require__(13),_metadata=__w_pdfjs_require__(14),_optional_content_config=__w_pdfjs_require__(16),_transport_stream=__w_pdfjs_require__(17),_webgl=__w_pdfjs_require__(18)
...
class PDFPageProxy{constructor(e,t,r,s,n=!1){this._pageIndex=e,this._pageInfo=t,this._ownerDocument=s,this._transport=r,this._stats=n?new _display_utils.StatTimer:null,this._pdfBug=n,this.commonObjs=r.commonObjs,this.objs=new PDFObjects,this.cleanupAfterRender=!1,this.pendingCleanup=!1,this._intentStates=new Map,this.destroyed=!1}get pageNumber(){return this._pageIndex+1}get rotate(){return this._pageInfo.rotate}get ref(){return this._pageInfo.ref}get userUnit(){return this._pageInfo.userUnit}get view(){return this._pageInfo.view}getViewport({scale:e,rotation:t=this.rotate,offsetX:r=0,offsetY:s=0,dontFlip:n=!1}={}){return new _display_utils.PageViewport({viewBox:this.view,scale:e,rotation:t,offsetX:r,offsetY:s,dontFlip:n})}getAnnotations({intent:e=null}={}){return this.annotationsPromise&&this.annotationsIntent===e||(this.annotationsPromise=this._transport.getAnnotations(this._pageIndex,e),this.annotationsIntent=e),this.annotationsPromise}getJSActions(){return this._jsActionsPromise||(this._jsActionsPromise=this._transport.getPageJSActions(this._pageIndex))}render({canvasContext:e,viewport:t,intent:r="display",enableWebGL:s=!1,renderInteractiveForms:n=!1,transform:i=null,imageLayer:a=null,canvasFactory:o=null,background:l=null,annotationStorage:c=null,optionalContentConfigPromise:h=null}){this._stats&&this._stats.time("Overall")
const d="print"===r?"print":"display"
this.pendingCleanup=!1,h||(h=this._transport.getOptionalContentConfig())
...
const p=o||new DefaultCanvasFactory({ownerDocument:this._ownerDocument}),g=new _webgl.WebGLContext({enable:s})
u.displayReadyCapability||(u.displayReadyCapability=(0,_util.createPromiseCapability)(),u.operatorList={fnArray:[],argsArray:[],lastChunk:!1},this._stats&&this._stats.time("Page Request"),this._pumpOperatorList({pageIndex:this._pageIndex,intent:d,renderInteractiveForms:!0===n,annotationStorage:c?.getAll()||null}))
const f=e=>{const t=u.renderTasks.indexOf(m)
t>=0&&u.renderTasks.splice(t,1),(this.cleanupAfterRender||"print"===d)&&(this.pendingCleanup=!0),this._tryCleanup(),e?(m.capability.reject(e),this._abortOperatorList({intentState:u,reason:e})):m.capability.resolve(),this._stats&&(this._stats.timeEnd("Rendering"),this._stats.timeEnd("Overall"))},m=new InternalRenderTask({callback:f,params:{canvasContext:e,viewport:t,transform:i,imageLayer:a,background:l},objs:this.objs,commonObjs:this.commonObjs,operatorList:u.operatorList,pageIndex:this._pageIndex,canvasFactory:p,webGLContext:g,useRequestAnimationFrame:"print"!==d,pdfBug:this._pdfBug})
u.renderTasks||(u.renderTasks=[]),u.renderTasks.push(m)
const A=m.task
return Promise.all([u.displayReadyCapability.promise,h]).then((([e,t])=>{this.pendingCleanup?f():(this._stats&&this._stats.time("Rendering"),m.initializeGraphics({transparency:e,optionalContentConfig:t}),m.operatorListChanged())})).catch(f),A}getOperatorList(){const e="oplist"
let t,r=this._intentStates.get(e)
return r||(r=Object.create(null),this._intentStates.set(e,r)),r.opListReadCapability||(t=Object.create(null),t.operatorListChanged=function(){if(r.operatorList.lastChunk){r.opListReadCapability.resolve(r.operatorList)
...
const e=[]
for(const[t,r]of this._intentStates)if(this._abortOperatorList({intentState:r,reason:new Error("Page was destroyed."),force:!0}),"oplist"!==t)for(const s of r.renderTasks)e.push(s.completed),s.cancel()
return this.objs.clear(),this.annotationsPromise=null,this._jsActionsPromise=null,this.pendingCleanup=!1,Promise.all(e)}cleanup(e=!1){return this.pendingCleanup=!0,this._tryCleanup(e)}_tryCleanup(e=!1){if(!this.pendingCleanup)return!1
for(const{renderTasks:t,operatorList:r}of this._intentStates.values())if(0!==t.length||!r.lastChunk)return!1
return this._intentStates.clear(),this.objs.clear(),this.annotationsPromise=null,this._jsActionsPromise=null,e&&this._stats&&(this._stats=new _display_utils.StatTimer),this.pendingCleanup=!1,!0}_startRenderPage(e,t){const r=this._intentStates.get(t)
...
let n,i
if((n=s.buffer)&&(0,_util.isArrayBuffer)(n))return i=t?.includes(n)?new s.constructor(n,s.byteOffset,s.byteLength):new s.constructor(s),r.set(s,i),i
...
try{e=globalThis.pdfjsWorker?.WorkerMessageHandler}catch(t){}return e||null}function setupFakeWorkerGlobal(){if(fakeWorkerCapability)return fakeWorkerCapability.promise
...
break
case"UnknownErrorException":r=new _util.UnknownErrorException(e.message,e.details)}if(!(r instanceof Error)){const e="DocException - expected a valid Error.";(0,_util.warn)(e)}t._capability.reject(r)})),e.on("PasswordRequest",(e=>{if(this._passwordCapability=(0,_util.createPromiseCapability)(),t.onPassword){const s=e=>{this._passwordCapability.resolve({password:e})}
...
break
case"FontPath":case"Image":this.commonObjs.resolve(r,n)
break
...
if(t){if(!t.cleanup())throw new Error(`startCleanup: Page ${e+1} is currently rendering.`)}}this.commonObjs.clear(),this.fontLoader.clear(),this._hasJSActionsPromise=null}))}get loadingParams(){const e=this._params
...
return r.data}has(e){return this._objs[e]?.resolved||!1}resolve(e,t){const r=this._ensureObj(e)
...
var s=r(2)
class n{constructor({docId:e,onUnsupportedFeature:t,ownerDocument:r=globalThis.document}){this.constructor===n&&(0,s.unreachable)("Cannot initialize BaseFontLoader."),this.docId=e,this._onUnsupportedFeature=t,this._document=r,this.nativeFontFaces=[],this.styleElement=null}addNativeFontFace(e){this.nativeFontFaces.push(e),this._document.fonts.add(e)}insertRule(e){let t=this.styleElement
...
const r=t.sheet
r.insertRule(e,r.cssRules.length)}clear(){this.nativeFontFaces.forEach((e=>{this._document.fonts.delete(e)})),this.nativeFontFaces.length=0,this.styleElement&&(this.styleElement.remove(),this.styleElement=null)}async bind(e){if(e.attached||e.missingFile)return
...
for(A.style.visibility="hidden",A.style.width=A.style.height="10px",A.style.position="absolute",A.style.top=A.style.left="0px",a=0,o=m.length;a<o;++a){const e=this._document.createElement("span")
e.textContent="Hi",e.style.fontFamily=m[a],A.appendChild(e)}this._document.body.appendChild(A),function e(t,r){if(h++,h>30)return(0,s.warn)("Load test font never loaded."),void r()
c.font="30px "+t,c.fillText(".",0,20),c.getImageData(0,0,1,1).data[3]>0?r():setTimeout(e.bind(null,t,r))}(d,(()=>{this._document.body.removeChild(A),r.complete()}))}}
...
return this.compiledGlyphs[t]=new Function("c","size",s)}return this.compiledGlyphs[t]=function(e,t){for(let s=0,i=r.length;s<i;s++)n=r[s],"scale"===n.cmd&&(n.args=[t,-t]),e[n.cmd].apply(e,n.args)}}}},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.NodeCMapReaderFactory=t.NodeCanvasFactory=void 0
var s=r(1),n=r(4),i=r(2)
...
t.NodeCMapReaderFactory=o,n.isNodeJS&&(t.NodeCanvasFactory=a=class extends s.BaseCanvasFactory{create(e,t){if(e<=0||t<=0)throw new Error("Invalid canvas size")
const r=require("canvas").createCanvas(e,t)
return{canvas:r,context:r.getContext("2d")}}},t.NodeCMapReaderFactory=o=class extends s.BaseCMapReaderFactory{_fetchData(e,t){return new Promise(((r,s)=>{require("fs").readFile(e,((e,n)=>{!e&&n?r({cMapData:new Uint8Array(n),compressionType:t}):s(new Error(e))}))}))}})},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.AnnotationStorage=void 0
var s=r(2)
t.AnnotationStorage=class{constructor(){this._storage=new Map,this._modified=!1,this.onSetModified=null,this.onResetModified=null}getOrCreateValue(e,t){return this._storage.has(e)?this._storage.get(e):(this._storage.set(e,t),t)}setValue(e,t){const r=this._storage.get(e)
let s=!1
if(void 0!==r)for(const[n,i]of Object.entries(t))r[n]!==i&&(s=!0,r[n]=i)
else this._storage.set(e,t),s=!0
s&&this._setModified()}getAll(){return 0===this._storage.size?null:(0,s.objectFromEntries)(this._storage)}get size(){return this._storage.size}_setModified(){this._modified||(this._modified=!0,"function"==typeof this.onSetModified&&this.onSetModified())}resetModified(){this._modified&&(this._modified=!1,"function"==typeof this.onResetModified&&this.onResetModified())}}},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.apiCompatibilityParams=void 0
var s=r(4)
const n=Object.create(null)
s.isNodeJS&&(n.disableFontFace=!0)
const i=Object.freeze(n)
t.apiCompatibilityParams=i},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.CanvasGraphics=void 0
var s=r(2),n=r(11)
const i=4096,a=16
function o(e){e.mozCurrentTransform||(e._originalSave=e.save,e._originalRestore=e.restore,e._originalRotate=e.rotate,e._originalScale=e.scale,e._originalTranslate=e.translate,e._originalTransform=e.transform,e._originalSetTransform=e.setTransform,e._transformMatrix=e._transformMatrix||[1,0,0,1,0,0],e._transformStack=[],Object.defineProperty(e,"mozCurrentTransform",{get:function(){return this._transformMatrix}}),Object.defineProperty(e,"mozCurrentTransformInverse",{get:function(){const e=this._transformMatrix,t=e[0],r=e[1],s=e[2],n=e[3],i=e[4],a=e[5],o=t*n-r*s,l=r*s-t*n
return[n/o,r/l,s/l,t/o,(n*i-s*a)/l,(r*i-t*a)/o]}}),e.save=function(){const e=this._transformMatrix
...
r[0]=r[0]*e,r[1]=r[1]*e,r[2]=r[2]*t,r[3]=r[3]*t,this._originalScale(e,t)},e.transform=function(t,r,s,n,i,a){const o=this._transformMatrix
this._transformMatrix=[o[0]*t+o[2]*r,o[1]*t+o[3]*r,o[0]*s+o[2]*n,o[1]*s+o[3]*n,o[0]*i+o[2]*a+o[4],o[1]*i+o[3]*a+o[5]],e._originalTransform(t,r,s,n,i,a)},e.setTransform=function(t,r,s,n,i,a){this._transformMatrix=[t,r,s,n,i,a],e._originalSetTransform(t,r,s,n,i,a)},e.rotate=function(e){const t=Math.cos(e),r=Math.sin(e),s=this._transformMatrix
this._transformMatrix=[s[0]*t+s[2]*r,s[1]*t+s[3]*r,s[0]*-r+s[2]*t,s[1]*-r+s[3]*t,s[4],s[5]],this._originalRotate(e)})}const l=function(){function e(e){this.canvasFactory=e,this.cache=Object.create(null)}return e.prototype={getCanvas:function(e,t,r,s){let n
return void 0!==this.cache[e]?(n=this.cache[e],this.canvasFactory.reset(n,t,r),n.context.setTransform(1,0,0,1,0,0)):(n=this.canvasFactory.create(t,r),this.cache[e]=n),s&&o(n.context),n},clear(){for(const e in this.cache){const t=this.cache[e]
this.canvasFactory.destroy(t),delete this.cache[e]}}},e}()
const c=function(){function e(){this.alphaIsShape=!1,this.fontSize=0,this.fontSizeScale=1,this.textMatrix=s.IDENTITY_MATRIX,this.textMatrixScale=1,this.fontMatrix=s.FONT_IDENTITY_MATRIX,this.leading=0,this.x=0,this.y=0,this.lineX=0,this.lineY=0,this.charSpacing=0,this.wordSpacing=0,this.textHScale=1,this.textRenderingMode=s.TextRenderingMode.FILL,this.textRise=0,this.fillColor="#000000",this.strokeColor="#000000",this.patternFill=!1,this.fillAlpha=1,this.strokeAlpha=1,this.lineWidth=1,this.activeSMask=null,this.resumeSMaskCtx=null,this.transferMaps=null}return e.prototype={clone:function(){return Object.create(this)},setCurrentPoint:function(e,t){this.x=e,this.y=t}},e}(),h=function(){function e(e,t,r,s,n,i,a){this.ctx=e,this.current=new c,this.stateStack=[],this.pendingClip=null,this.pendingEOFill=!1,this.res=null,this.xobjs=null,this.commonObjs=t,this.objs=r,this.canvasFactory=s,this.webGLContext=n,this.imageLayer=i,this.groupStack=[],this.processingType3=null,this.baseTransform=null,this.baseTransformStack=[],this.groupLevel=0,this.smaskStack=[],this.smaskCounter=0,this.tempSMask=null,this.contentVisible=!0,this.markedContentStack=[],this.optionalContentConfig=a,this.cachedCanvases=new l(this.canvasFactory),e&&o(e),this._cachedGetSinglePixelWidth=null}function t(e,t,r=null){if("undefined"!=typeof ImageData&&t instanceof ImageData)return void e.putImageData(t,0,0)
const n=t.height,i=t.width,o=n%a,l=(n-o)/a,c=0===o?l:l+1,h=e.createImageData(i,a)
let d,u=0
const p=t.data,g=h.data
let f,m,A,_,b,y,S,v
if(r)switch(r.length){case 1:b=r[0],y=r[0],S=r[0],v=r[0]
break
case 4:b=r[0],y=r[1],S=r[2],v=r[3]}if(t.kind===s.ImageKind.GRAYSCALE_1BPP){const t=p.byteLength,r=new Uint32Array(g.buffer,0,g.byteLength>>2),n=r.length,_=i+7>>3
let b=4294967295,y=s.IsLittleEndianCached.value?4278190080:255
for(v&&255===v[0]&&0===v[255]&&([b,y]=[y,b]),f=0;f<c;f++){for(A=f<l?a:o,d=0,m=0;m<A;m++){const e=t-u
let s=0
const n=e>_?i:8*e-7,a=-8&n
let o=0,l=0
for(;s<a;s+=8)l=p[u++],r[d++]=128&l?b:y,r[d++]=64&l?b:y,r[d++]=32&l?b:y,r[d++]=16&l?b:y,r[d++]=8&l?b:y,r[d++]=4&l?b:y,r[d++]=2&l?b:y,r[d++]=1&l?b:y
for(;s<n;s++)0===o&&(l=p[u++],o=128),r[d++]=l&o?b:y,o>>=1}for(;d<n;)r[d++]=0
e.putImageData(h,0,f*a)}}else if(t.kind===s.ImageKind.RGBA_32BPP){const t=!!(b||y||S)
for(m=0,_=i*a*4,f=0;f<l;f++){if(g.set(p.subarray(u,u+_)),u+=_,t)for(let e=0;e<_;e+=4)b&&(g[e+0]=b[g[e+0]]),y&&(g[e+1]=y[g[e+1]]),S&&(g[e+2]=S[g[e+2]])
e.putImageData(h,0,m),m+=a}if(f<c){if(_=i*o*4,g.set(p.subarray(u,u+_)),t)for(let e=0;e<_;e+=4)b&&(g[e+0]=b[g[e+0]]),y&&(g[e+1]=y[g[e+1]]),S&&(g[e+2]=S[g[e+2]])
e.putImageData(h,0,m)}}else{if(t.kind!==s.ImageKind.RGB_24BPP)throw new Error(`bad image kind: ${t.kind}`)
{const t=!!(b||y||S)
for(A=a,_=i*A,f=0;f<c;f++){for(f>=l&&(A=o,_=i*A),d=0,m=_;m--;)g[d++]=p[u++],g[d++]=p[u++],g[d++]=p[u++],g[d++]=255
if(t)for(let e=0;e<d;e+=4)b&&(g[e+0]=b[g[e+0]]),y&&(g[e+1]=y[g[e+1]]),S&&(g[e+2]=S[g[e+2]])
e.putImageData(h,0,f*a)}}}}function r(e,t){const r=t.height,s=t.width,n=r%a,i=(r-n)/a,o=0===n?i:i+1,l=e.createImageData(s,a)
let c=0
const h=t.data,d=l.data
for(let u=0;u<o;u++){const t=u<i?a:n
let r=3
for(let e=0;e<t;e++){let e,t=0
for(let n=0;n<s;n++)t||(e=h[c++],t=128),d[r]=e&t?0:255,r+=4,t>>=1}e.putImageData(l,0,u*a)}}function h(e,t){const r=["strokeStyle","fillStyle","fillRule","globalAlpha","lineWidth","lineCap","lineJoin","miterLimit","globalCompositeOperation","font"]
for(let s=0,n=r.length;s<n;s++){const n=r[s]
void 0!==e[n]&&(t[n]=e[n])}void 0!==e.setLineDash&&(t.setLineDash(e.getLineDash()),t.lineDashOffset=e.lineDashOffset)}function d(e){e.strokeStyle="#000000",e.fillStyle="#000000",e.fillRule="nonzero",e.globalAlpha=1,e.lineWidth=1,e.lineCap="butt",e.lineJoin="miter",e.miterLimit=10,e.globalCompositeOperation="source-over",e.font="10px sans-serif",void 0!==e.setLineDash&&(e.setLineDash([]),e.lineDashOffset=0)}function u(e,t,r,s){const n=e.length
for(let i=3;i<n;i+=4){const n=e[i]
if(0===n)e[i-3]=t,e[i-2]=r,e[i-1]=s
else if(n<255){const a=255-n
e[i-3]=e[i-3]*n+t*a>>8,e[i-2]=e[i-2]*n+r*a>>8,e[i-1]=e[i-1]*n+s*a>>8}}}function p(e,t,r){const s=e.length
for(let n=3;n<s;n+=4){const s=r?r[e[n]]:e[n]
t[n]=t[n]*s*.00392156862745098|0}}function g(e,t,r){const s=e.length
for(let n=3;n<s;n+=4){const s=77*e[n-3]+152*e[n-2]+28*e[n-1]
t[n]=r?t[n]*r[s>>8]>>8:t[n]*s>>16}}function f(e,t,r,s){const n=t.canvas,i=t.context
...
return e.setTransform(1,0,0,1,0,0),void e.drawImage(i,t.offsetX,t.offsetY)}(function(e,t,r,s,n,i,a){const o=!!i,l=o?i[0]:0,c=o?i[1]:0,h=o?i[2]:0
let d
d="Luminosity"===n?g:p
const f=Math.min(s,Math.ceil(1048576/r))
for(let p=0;p<s;p+=f){const n=Math.min(f,s-p),i=e.getImageData(0,p,r,n),g=t.getImageData(0,p,r,n)
o&&u(i.data,l,c,h),d(i.data,g.data,a),e.putImageData(g,0,p)}})(i,r,n.width,n.height,t.subtype,a,t.transferMap),e.drawImage(n,0,0)}const m=["butt","round","square"],A=["miter","round","bevel"],_={},b={}
e.prototype={beginDrawing({transform:e,viewport:t,transparency:r=!1,background:s=null}){const n=this.ctx.canvas.width,i=this.ctx.canvas.height
if(this.ctx.save(),this.ctx.fillStyle=s||"rgb(255, 255, 255)",this.ctx.fillRect(0,0,n,i),this.ctx.restore(),r){const e=this.cachedCanvases.getCanvas("transparent",n,i,!0)
this.compositeCtx=this.ctx,this.transparentCanvas=e.canvas,this.ctx=e.context,this.ctx.save(),this.ctx.transform.apply(this.ctx,this.compositeCtx.mozCurrentTransform)}this.ctx.save(),d(this.ctx),e&&this.ctx.transform.apply(this.ctx,e),this.ctx.transform.apply(this.ctx,t.transform),this.baseTransform=this.ctx.mozCurrentTransform.slice(),this._combinedScaleFactor=Math.hypot(this.baseTransform[0],this.baseTransform[2]),this.imageLayer&&this.imageLayer.beginLayout()},executeOperatorList:function(e,t,r,n){const i=e.argsArray,a=e.fnArray
let o=t||0
const l=i.length
if(l===o)return o
...
break
case"TR":this.current.transferMaps=n}}},beginSMaskGroup:function(){const e=this.current.activeSMask,t=e.canvas.width,r=e.canvas.height,s="smaskGroupAt"+this.groupLevel,n=this.cachedCanvases.getCanvas(s,t,r,!0),i=this.ctx,a=i.mozCurrentTransform
this.ctx.save()
const o=n.context
o.scale(1/e.scaleX,1/e.scaleY),o.translate(-e.offsetX,-e.offsetY),o.transform.apply(o,a),e.startTransformInverse=o.mozCurrentTransformInverse,h(i,o),this.ctx=o,this.setGState([["BM","source-over"],["ca",1],["CA",1]]),this.groupStack.push(i),this.groupLevel++},suspendSMaskGroup:function(){const e=this.ctx
this.groupLevel--,this.ctx=this.groupStack.pop(),f(this.ctx,this.current.activeSMask,e,this.webGLContext),this.ctx.restore(),this.ctx.save(),h(e,this.ctx),this.current.resumeSMaskCtx=e
...
if(t.globalAlpha=this.current.strokeAlpha,this.contentVisible)if("object"==typeof r&&r?.getPattern){t.save()
const e=t.mozCurrentTransform,n=s.Util.singularValueDecompose2dScale(e)[0]
t.strokeStyle=r.getPattern(t,this)
const i=this.getSinglePixelWidth(),a=this.current.lineWidth*n
i<0&&-i>=a?(t.resetTransform(),t.lineWidth=Math.round(this._combinedScaleFactor)):t.lineWidth=Math.max(i,a),t.stroke(),t.restore()}else{const e=this.getSinglePixelWidth()
...
let s=!1
this.current.patternFill&&(t.save(),this.baseTransform&&t.setTransform.apply(t,this.baseTransform),t.fillStyle=r.getPattern(t,this),s=!0),this.contentVisible&&(this.pendingEOFill?(t.fill("evenodd"),this.pendingEOFill=!1):t.fill()),s&&t.restore(),e&&this.consumePath()},eoFill:function(){this.pendingEOFill=!0,this.fill()},fillStroke:function(){this.fill(!1),this.stroke(!1),this.consumePath()},eoFillStroke:function(){this.pendingEOFill=!0,this.fillStroke()},closeFillStroke:function(){this.closePath(),this.fillStroke()},closeEOFillStroke:function(){this.pendingEOFill=!0,this.closePath(),this.fillStroke()},endPath:function(){this.consumePath()},clip:function(){this.pendingClip=_},eoClip:function(){this.pendingClip=b},beginText:function(){this.current.textMatrix=s.IDENTITY_MATRIX,this.current.textMatrixScale=1,this.current.x=this.current.lineX=0,this.current.y=this.current.lineY=0},endText:function(){const e=this.pendingTextPaths,t=this.ctx
...
if(n.fontMatrix=r.fontMatrix||s.FONT_IDENTITY_MATRIX,0!==n.fontMatrix[0]&&0!==n.fontMatrix[3]||(0,s.warn)("Invalid font matrix for font "+e),t<0?(t=-t,n.fontDirection=-1):n.fontDirection=1,this.current.font=r,this.current.fontSize=t,r.isType3Font)return
const i=r.loadedName||"sans-serif"
let a="normal"
r.black?a="900":r.bold&&(a="bold")
const o=r.italic?"italic":"normal",l=`"${i}", ${r.fallbackName}`
let c=t
t<16?c=16:t>100&&(c=100),this.current.fontSizeScale=t/c,this.ctx.font=`${o} ${a} ${c}px ${l}`},setTextRenderingMode:function(e){this.current.textRenderingMode=e},setTextRise:function(e){this.current.textRise=e},moveText:function(e,t){this.current.x=this.current.lineX+=e,this.current.y=this.current.lineY+=t},setLeadingMoveText:function(e,t){this.setLeading(-t),this.moveText(e,t)},setTextMatrix:function(e,t,r,s,n,i){this.current.textMatrix=[e,t,r,s,n,i],this.current.textMatrixScale=Math.sqrt(e*e+t*t),this.current.x=this.current.lineX=0,this.current.y=this.current.lineY=0},nextLine:function(){this.moveText(0,this.current.leading)},paintChar(e,t,r,n,i){const a=this.ctx,o=this.current,l=o.font,c=o.textRenderingMode,h=o.fontSize/o.fontSizeScale,d=c&s.TextRenderingMode.FILL_STROKE_MASK,u=!!(c&s.TextRenderingMode.ADD_TO_PATH_FLAG),p=o.patternFill&&!l.missingFile
let g
if((l.disableFontFace||u||p)&&(g=l.getPathGenerator(this.commonObjs,e)),l.disableFontFace||p?(a.save(),a.translate(t,r),a.beginPath(),g(a,h),n&&a.setTransform.apply(a,n),d!==s.TextRenderingMode.FILL&&d!==s.TextRenderingMode.FILL_STROKE||a.fill(),d!==s.TextRenderingMode.STROKE&&d!==s.TextRenderingMode.FILL_STROKE||(i&&(a.resetTransform(),a.lineWidth=Math.round(this._combinedScaleFactor)),a.stroke()),a.restore()):(d!==s.TextRenderingMode.FILL&&d!==s.TextRenderingMode.FILL_STROKE||a.fillText(e,t,r),d!==s.TextRenderingMode.STROKE&&d!==s.TextRenderingMode.FILL_STROKE||(i?(a.save(),a.moveTo(t,r),a.resetTransform(),a.lineWidth=Math.round(this._combinedScaleFactor),a.strokeText(e,0,0),a.restore()):a.strokeText(e,t,r))),u){(this.pendingTextPaths||(this.pendingTextPaths=[])).push({transform:a.mozCurrentTransform,x:t,y:r,fontSize:h,addToPath:g})}},get isFontSubpixelAAEnabled(){const{context:e}=this.cachedCanvases.getCanvas("isFontSubpixelAAEnabled",10,10)
e.scale(1.5,1),e.fillText("I",0,10)
const t=e.getImageData(0,0,10,10).data
let r=!1
for(let s=3;s<t.length;s+=4)if(t[s]>0&&t[s]<255){r=!0
break}return(0,s.shadow)(this,"isFontSubpixelAAEnabled",r)},showText:function(e){const t=this.current,r=t.font
if(r.isType3Font)return this.showType3Text(e)
const n=t.fontSize
if(0===n)return
const i=this.ctx,a=t.fontSizeScale,o=t.charSpacing,l=t.wordSpacing,c=t.fontDirection,h=t.textHScale*c,d=e.length,u=r.vertical,p=u?1:-1,g=r.defaultVMetrics,f=n*t.fontMatrix[0],m=t.textRenderingMode===s.TextRenderingMode.FILL&&!r.disableFontFace&&!t.patternFill
let A
if(i.save(),t.patternFill){i.save()
const e=t.fillColor.getPattern(i,this)
A=i.mozCurrentTransform,i.restore(),i.fillStyle=e}i.transform.apply(i,t.textMatrix),i.translate(t.x,t.y+t.textRise),c>0?i.scale(h,-1):i.scale(h,1)
let _=t.lineWidth,b=!1
const y=t.textMatrixScale
if(0===y||0===_){const e=t.textRenderingMode&s.TextRenderingMode.FILL_STROKE_MASK
e!==s.TextRenderingMode.STROKE&&e!==s.TextRenderingMode.FILL_STROKE||(this._cachedGetSinglePixelWidth=null,_=this.getSinglePixelWidth(),b=_<0)}else _/=y
1!==a&&(i.scale(a,a),_/=a),i.lineWidth=_
let S,v=0
for(S=0;S<d;++S){const t=e[S]
if((0,s.isNum)(t)){v+=p*t*n/1e3
continue}let h=!1
const d=(t.isSpace?l:0)+o,_=t.fontChar,y=t.accent
let C,x,k,P=t.width
if(u){const e=t.vmetric||g,r=-(t.vmetric?e[1]:.5*P)*f,s=e[2]*f
P=e?-e[0]:P,C=r/a,x=(v+s)/a}else C=v/a,x=0
if(r.remeasure&&P>0){const e=1e3*i.measureText(_).width/n*a
if(P<e&&this.isFontSubpixelAAEnabled){const t=P/e
h=!0,i.save(),i.scale(t,1),C/=t}else P!==e&&(C+=(P-e)/2e3*n/a)}if(this.contentVisible&&(t.isInFont||r.missingFile))if(m&&!y)i.fillText(_,C,x)
else if(this.paintChar(_,C,x,A,b),y){const e=C+n*y.offset.x/a,t=x-n*y.offset.y/a
this.paintChar(y.fontChar,e,t,A,b)}k=u?P*f-d*c:P*f+d*c,v+=k,h&&i.restore()}u?t.y-=v:t.x+=v*h,i.restore()},showType3Text:function(e){const t=this.ctx,r=this.current,n=r.font,i=r.fontSize,a=r.fontDirection,o=n.vertical?1:-1,l=r.charSpacing,c=r.wordSpacing,h=r.textHScale*a,d=r.fontMatrix||s.FONT_IDENTITY_MATRIX,u=e.length
let p,g,f,m
if(!(r.textRenderingMode===s.TextRenderingMode.INVISIBLE)&&0!==i){for(this._cachedGetSinglePixelWidth=null,t.save(),t.transform.apply(t,r.textMatrix),t.translate(r.x,r.y),t.scale(h,a),p=0;p<u;++p){if(g=e[p],(0,s.isNum)(g)){m=o*g*i/1e3,this.ctx.translate(m,0),r.x+=m*h
continue}const a=(g.isSpace?c:0)+l,u=n.charProcOperatorList[g.operatorListId]
if(!u){(0,s.warn)(`Type3 character "${g.operatorListId}" is not available.`)
continue}this.contentVisible&&(this.processingType3=g,this.save(),t.scale(i,i),t.transform.apply(t,d),this.executeOperatorList(u),this.restore())
f=s.Util.applyTransform([g.width,0],d)[0]*i+a,t.translate(f,0),r.x+=f*h}t.restore(),this.processingType3=null}},setCharWidth:function(e,t){},setCharWidthAndBounds:function(e,t,r,s,n,i){this.ctx.rect(r,s,n-r,i-s),this.clip(),this.endPath()},getColorN_Pattern:function(t){let r
if("TilingPattern"===t[0]){const s=t[1],i=this.baseTransform||this.ctx.mozCurrentTransform.slice(),a={createCanvasGraphics:t=>new e(t,this.commonObjs,this.objs,this.canvasFactory,this.webGLContext)}
r=new n.TilingPattern(t,s,this.ctx,a,i)}else r=(0,n.getShadingPatternFromIR)(t)
return r},setStrokeColorN:function(){this.current.strokeColor=this.getColorN_Pattern(arguments)},setFillColorN:function(){this.current.fillColor=this.getColorN_Pattern(arguments),this.current.patternFill=!0},setStrokeRGBColor:function(e,t,r){const n=s.Util.makeHexColor(e,t,r)
this.ctx.strokeStyle=n,this.current.strokeColor=n},setFillRGBColor:function(e,t,r){const n=s.Util.makeHexColor(e,t,r)
this.ctx.fillStyle=n,this.current.fillColor=n,this.current.patternFill=!1},shadingFill:function(e){if(!this.contentVisible)return
const t=this.ctx
this.save()
const r=(0,n.getShadingPatternFromIR)(e)
t.fillStyle=r.getPattern(t,this,!0)
const i=t.mozCurrentTransformInverse
if(i){const e=t.canvas,r=e.width,n=e.height,a=s.Util.applyTransform([0,0],i),o=s.Util.applyTransform([0,n],i),l=s.Util.applyTransform([r,0],i),c=s.Util.applyTransform([r,n],i),h=Math.min(a[0],o[0],l[0],c[0]),d=Math.min(a[1],o[1],l[1],c[1]),u=Math.max(a[0],o[0],l[0],c[0]),p=Math.max(a[1],o[1],l[1],c[1])
this.ctx.fillRect(h,d,u-h,p-d)}else this.ctx.fillRect(-1e10,-1e10,2e10,2e10)
this.restore()},beginInlineImage:function(){(0,s.unreachable)("Should not call beginInlineImage")},beginImageData:function(){(0,s.unreachable)("Should not call beginImageData")},paintFormXObjectBegin:function(e,t){if(this.contentVisible&&(this.save(),this.baseTransformStack.push(this.baseTransform),Array.isArray(e)&&6===e.length&&this.transform.apply(this,e),this.baseTransform=this.ctx.mozCurrentTransform,t)){const e=t[2]-t[0],r=t[3]-t[1]
this.ctx.rect(t[0],t[1],e,r),this.clip(),this.endPath()}},paintFormXObjectEnd:function(){this.contentVisible&&(this.restore(),this.baseTransform=this.baseTransformStack.pop())},beginGroup:function(e){if(!this.contentVisible)return
this.save()
const t=this.ctx
...
const o=Math.floor(n[0]),l=Math.floor(n[1])
let c=Math.max(Math.ceil(n[2])-o,1),d=Math.max(Math.ceil(n[3])-l,1),u=1,p=1
c>i&&(u=c/i,c=i),d>i&&(p=d/i,d=i)
let g="groupAt"+this.groupLevel
e.smask&&(g+="_smask_"+this.smaskCounter++%2)
const f=this.cachedCanvases.getCanvas(g,c,d,!0),m=f.context
m.scale(1/u,1/p),m.translate(-o,-l),m.transform.apply(m,r),e.smask?this.smaskStack.push({canvas:f.canvas,context:m,offsetX:o,offsetY:l,scaleX:u,scaleY:p,subtype:e.smask.subtype,backdrop:e.smask.backdrop,transferMap:e.smask.transferMap||null,startTransformInverse:null}):(t.setTransform(1,0,0,1,0,0),t.translate(o,l),t.scale(u,p)),h(t,m),this.ctx=m,this.setGState([["BM","source-over"],["ca",1],["CA",1]]),this.groupStack.push(t),this.groupLevel++,this.current.activeSMask=null},endGroup:function(e){if(!this.contentVisible)return
this.groupLevel--
const t=this.ctx
this.ctx=this.groupStack.pop(),void 0!==this.ctx.imageSmoothingEnabled?this.ctx.imageSmoothingEnabled=!1:this.ctx.mozImageSmoothingEnabled=!1,e.smask?this.tempSMask=this.smaskStack.pop():this.ctx.drawImage(t.canvas,0,0),this.restore()},beginAnnotations:function(){this.save(),this.baseTransform&&this.ctx.setTransform.apply(this.ctx,this.baseTransform)},endAnnotations:function(){this.restore()},beginAnnotation:function(e,t,r){if(this.save(),d(this.ctx),this.current=new c,Array.isArray(e)&&4===e.length){const t=e[2]-e[0],r=e[3]-e[1]
this.ctx.rect(e[0],e[1],t,r),this.clip(),this.endPath()}this.transform.apply(this,t),this.transform.apply(this,r)},endAnnotation:function(){this.restore()},paintImageMaskXObject:function(e){if(!this.contentVisible)return
const t=this.ctx,s=e.width,n=e.height,i=this.current.fillColor,a=this.current.patternFill,o=this.processingType3
if(o&&void 0===o.compiled&&(o.compiled=s<=1e3&&n<=1e3?function(e){const t=e.width,r=e.height,s=t+1
let n,i,a,o
const l=new Uint8Array(s*(r+1)),c=new Uint8Array([0,2,4,0,1,0,5,4,8,10,0,8,0,2,1,0]),h=t+7&-8,d=e.data,u=new Uint8Array(h*r)
let p=0
for(n=0,i=d.length;n<i;n++){const e=d[n]
let t=128
for(;t>0;)u[p++]=e&t?0:255,t>>=1}let g=0
for(p=0,0!==u[p]&&(l[0]=1,++g),a=1;a<t;a++)u[p]!==u[p+1]&&(l[a]=u[p]?2:1,++g),p++
for(0!==u[p]&&(l[a]=2,++g),n=1;n<r;n++){p=n*h,o=n*s,u[p-h]!==u[p]&&(l[o]=u[p]?1:8,++g)
let e=(u[p]?4:0)+(u[p-h]?8:0)
for(a=1;a<t;a++)e=(e>>2)+(u[p+1]?4:0)+(u[p-h+1]?8:0),c[e]&&(l[o+a]=c[e],++g),p++
if(u[p-h]!==u[p]&&(l[o+a]=u[p]?2:4,++g),g>1e3)return null}for(p=h*(r-1),o=n*s,0!==u[p]&&(l[o]=8,++g),a=1;a<t;a++)u[p]!==u[p+1]&&(l[o+a]=u[p]?4:8,++g),p++
if(0!==u[p]&&(l[o+a]=4,++g),g>1e3)return null
const f=new Int32Array([0,s,-1,0,-s,0,0,0,1]),m=[]
for(n=0;g&&n<=r;n++){let e=n*s
const r=e+t
for(;e<r&&!l[e];)e++
if(e===r)continue
const i=[e%s,n],a=e
...
do{e+=t}while(!l[e])
const r=l[e]
5!==r&&10!==r?(o=r,l[e]=0):(o=r&51*o>>4,l[e]&=o>>2|o<<2),i.push(e%s),i.push(e/s|0),l[e]||--g}while(a!==e)
m.push(i),--n}return function(e){e.save(),e.scale(1/t,-1/r),e.translate(0,-r),e.beginPath()
for(let t=0,r=m.length;t<r;t++){const r=m[t]
e.moveTo(r[0],r[1])
for(let t=2,s=r.length;t<s;t+=2)e.lineTo(r[t],r[t+1])}e.fill(),e.beginPath(),e.restore()}}({data:e.data,width:s,height:n}):null),o?.compiled)return void o.compiled(t)
const l=this.cachedCanvases.getCanvas("maskCanvas",s,n),c=l.context
c.save(),r(c,e),c.globalCompositeOperation="source-in",c.fillStyle=a?i.getPattern(c,this):i,c.fillRect(0,0,s,n),c.restore(),this.paintInlineImageXObject(l.canvas)},paintImageMaskXObjectRepeat(e,t,s=0,n=0,i,a){if(!this.contentVisible)return
...
u.save(),r(u,e),u.globalCompositeOperation="source-in",u.fillStyle=h?c.getPattern(u,this):c,u.fillRect(0,0,o,l),u.restore()
const p=this.ctx
for(let r=0,g=a.length;r<g;r+=2)p.save(),p.transform(t,s,n,i,a[r],a[r+1]),p.scale(1,-1),p.drawImage(d.canvas,0,0,o,l,0,-1,1,1),p.restore()},paintImageMaskXObjectGroup:function(e){if(!this.contentVisible)return
const t=this.ctx,s=this.current.fillColor,n=this.current.patternFill
for(let i=0,a=e.length;i<a;i++){const a=e[i],o=a.width,l=a.height,c=this.cachedCanvases.getCanvas("maskCanvas",o,l),h=c.context
h.save(),r(h,a),h.globalCompositeOperation="source-in",h.fillStyle=n?s.getPattern(h,this):s,h.fillRect(0,0,o,l),h.restore(),t.save(),t.transform.apply(t,a.transform),t.scale(1,-1),t.drawImage(c.canvas,0,0,o,l,0,-1,1,1),t.restore()}},paintImageXObject:function(e){if(!this.contentVisible)return
const t=e.startsWith("g_")?this.commonObjs.get(e):this.objs.get(e)
t?this.paintInlineImageXObject(t):(0,s.warn)("Dependent image isn't ready yet")},paintImageXObjectRepeat:function(e,t,r,n){if(!this.contentVisible)return
const i=e.startsWith("g_")?this.commonObjs.get(e):this.objs.get(e)
if(!i)return void(0,s.warn)("Dependent image isn't ready yet")
const a=i.width,o=i.height,l=[]
for(let s=0,c=n.length;s<c;s+=2)l.push({transform:[t,0,0,r,n[s],n[s+1]],x:0,y:0,w:a,h:o})
this.paintInlineImageXObjectGroup(i,l)},paintInlineImageXObject:function(e){if(!this.contentVisible)return
const r=e.width,s=e.height,n=this.ctx
this.save(),n.scale(1/r,-1/s)
const i=n.mozCurrentTransformInverse,a=i[0],o=i[1]
let l=Math.max(Math.sqrt(a*a+o*o),1)
const c=i[2],h=i[3]
let d,u,p,g=Math.max(Math.sqrt(c*c+h*h),1)
"function"==typeof HTMLElement&&e instanceof HTMLElement||!e.data?d=e:(u=this.cachedCanvases.getCanvas("inlineImage",r,s),p=u.context,t(p,e,this.current.transferMaps),d=u.canvas)
let f=r,m=s,A="prescale1"
for(;l>2&&f>1||g>2&&m>1;){let e=f,t=m
l>2&&f>1&&(e=Math.ceil(f/2),l/=f/e),g>2&&m>1&&(t=Math.ceil(m/2),g/=m/t),u=this.cachedCanvases.getCanvas(A,e,t),p=u.context,p.clearRect(0,0,e,t),p.drawImage(d,0,0,f,m,0,0,e,t),d=u.canvas,f=e,m=t,A="prescale1"===A?"prescale2":"prescale1"}if(n.drawImage(d,0,0,f,m,0,-s,r,s),this.imageLayer){const t=this.getCanvasPosition(0,-s)
this.imageLayer.appendImage({imgData:e,left:t[0],top:t[1],width:r/i[0],height:s/i[3]})}this.restore()},paintInlineImageXObjectGroup:function(e,r){if(!this.contentVisible)return
const s=this.ctx,n=e.width,i=e.height,a=this.cachedCanvases.getCanvas("inlineImage",n,i)
t(a.context,e,this.current.transferMaps)
for(let t=0,o=r.length;t<o;t++){const o=r[t]
if(s.save(),s.transform.apply(s,o.transform),s.scale(1,-1),s.drawImage(a.canvas,o.x,o.y,o.w,o.h,0,-1,1,1),this.imageLayer){const t=this.getCanvasPosition(o.x,o.y)
...
this.pendingClip&&(this.pendingClip===b?e.clip("evenodd"):e.clip(),this.pendingClip=null),e.beginPath()},getSinglePixelWidth(){if(null===this._cachedGetSinglePixelWidth){const e=this.ctx.mozCurrentTransform,t=Math.abs(e[0]*e[3]-e[2]*e[1]),r=e[0]**2+e[2]**2,s=e[1]**2+e[3]**2,n=Math.sqrt(Math.max(r,s))/t
r!==s&&this._combinedScaleFactor*n>1?this._cachedGetSinglePixelWidth=-this._combinedScaleFactor*n:t>Number.EPSILON?this._cachedGetSinglePixelWidth=1.0000001*n:this._cachedGetSinglePixelWidth=1}return this._cachedGetSinglePixelWidth},getCanvasPosition:function(e,t){const r=this.ctx.mozCurrentTransform
return[r[0]*e+r[2]*t+r[4],r[1]*e+r[3]*t+r[5]]},isContentVisible:function(){for(let e=this.markedContentStack.length-1;e>=0;e--)if(!this.markedContentStack[e].visible)return!1
return!0}}
for(const n in s.OPS)e.prototype[s.OPS[n]]=e.prototype[n]
return e}()
t.CanvasGraphics=h},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.getShadingPatternFromIR=function(e){const t=n[e[0]]
...
n.rect(t[0],t[1],r,s),e.clip(n)}n.RadialAxial={fromIR:function(e){const t=e[1],r=e[2],s=e[3],n=e[4],a=e[5],o=e[6],l=e[7]
...
for(let t=0,r=s.length;t<r;++t){const e=s[t]
c.addColorStop(e[0],e[1])}return c}}}}
const a=function(){function e(e,t,r,s,n,i,a,o){const l=t.coords,c=t.colors,h=e.data,d=4*e.width
let u
l[r+1]>l[s+1]&&(u=r,r=s,s=u,u=i,i=a,a=u),l[s+1]>l[n+1]&&(u=s,s=n,n=u,u=a,a=o,o=u),l[r+1]>l[s+1]&&(u=r,r=s,s=u,u=i,i=a,a=u)
const p=(l[r]+t.offsetX)*t.scaleX,g=(l[r+1]+t.offsetY)*t.scaleY,f=(l[s]+t.offsetX)*t.scaleX,m=(l[s+1]+t.offsetY)*t.scaleY,A=(l[n]+t.offsetX)*t.scaleX,_=(l[n+1]+t.offsetY)*t.scaleY
if(g>=_)return
const b=c[i],y=c[i+1],S=c[i+2],v=c[a],C=c[a+1],x=c[a+2],k=c[o],P=c[o+1],w=c[o+2],R=Math.round(g),T=Math.round(_)
let E,F,M,L,O,D,I,N
for(let j=R;j<=T;j++){if(j<m){let e
e=j<g?0:g===m?1:(g-j)/(g-m),E=p-(p-f)*e,F=b-(b-v)*e,M=y-(y-C)*e,L=S-(S-x)*e}else{let e
e=j>_?1:m===_?0:(m-j)/(m-_),E=f-(f-A)*e,F=v-(v-k)*e,M=C-(C-P)*e,L=x-(x-w)*e}let e
e=j<g?0:j>_?1:(g-j)/(g-_),O=p-(p-A)*e,D=b-(b-k)*e,I=y-(y-P)*e,N=S-(S-w)*e
const t=Math.round(Math.min(E,O)),r=Math.round(Math.max(E,O))
let s=d*j+4*t
for(let n=t;n<=r;n++)e=(E-n)/(E-O),e<0?e=0:e>1&&(e=1),h[s++]=F-(F-D)*e|0,h[s++]=M-(M-I)*e|0,h[s++]=L-(L-N)*e|0,h[s++]=255}}function t(t,r,s){const n=r.coords,i=r.colors
let a,o
switch(r.type){case"lattice":const l=r.verticesPerRow,c=Math.floor(n.length/l)-1,h=l-1
for(a=0;a<c;a++){let r=a*l
for(let a=0;a<h;a++,r++)e(t,s,n[r],n[r+1],n[r+l],i[r],i[r+1],i[r+l]),e(t,s,n[r+l+1],n[r+1],n[r+l],i[r+l+1],i[r+1],i[r+l])}break
case"triangles":for(a=0,o=n.length;a<o;a+=3)e(t,s,n[a],n[a+1],n[a+2],i[a],i[a+1],i[a+2])
break
default:throw new Error("illegal figure")}}return function(e,r,s,n,i,a,o,l){const c=Math.floor(e[0]),h=Math.floor(e[1]),d=Math.ceil(e[2])-c,u=Math.ceil(e[3])-h,p=Math.min(Math.ceil(Math.abs(d*r[0]*1.1)),3e3),g=Math.min(Math.ceil(Math.abs(u*r[1]*1.1)),3e3),f=d/p,m=u/g,A={coords:s,colors:n,offsetX:-c,offsetY:-h,scaleX:1/f,scaleY:1/m},_=p+4,b=g+4
let y,S,v,C
if(l.isEnabled)y=l.drawFigures({width:p,height:g,backgroundColor:a,figures:i,context:A}),S=o.getCanvas("mesh",_,b,!1),S.context.drawImage(y,2,2),y=S.canvas
else{S=o.getCanvas("mesh",_,b,!1)
const e=S.context,r=e.createImageData(p,g)
if(a){const e=r.data
for(v=0,C=e.length;v<C;v+=4)e[v]=a[0],e[v+1]=a[1],e[v+2]=a[2],e[v+3]=255}for(v=0;v<i.length;v++)t(r,i[v],A)
e.putImageData(r,2,2),y=S.canvas}return{canvas:y,offsetX:c-2*f,offsetY:h-2*m,scaleX:f,scaleY:m}}}()
n.Mesh={fromIR:function(e){const t=e[2],r=e[3],n=e[4],o=e[5],l=e[6],c=e[7],h=e[8]
return{getPattern:function(e,d,u){let p
if(i(e,c),u)p=s.Util.singularValueDecompose2dScale(e.mozCurrentTransform)
else if(p=s.Util.singularValueDecompose2dScale(d.baseTransform),l){const e=s.Util.singularValueDecompose2dScale(l)
p=[p[0]*e[0],p[1]*e[1]]}const g=a(o,p,t,r,n,u?null:h,d.cachedCanvases,d.webGLContext)
return u||(e.setTransform.apply(e,d.baseTransform),l&&e.transform.apply(e,l)),e.translate(g.offsetX,g.offsetY),e.scale(g.scaleX,g.scaleY),e.createPattern(g.canvas,"no-repeat")}}}},n.Dummy={fromIR:function(){return{getPattern:function(){return"hotpink"}}}}
const o=function(){const e=1,t=2
...
const h=r[0],d=r[1],u=r[2],p=r[3],g=s.Util.singularValueDecompose2dScale(this.matrix),f=s.Util.singularValueDecompose2dScale(this.baseTransform),m=[g[0]*f[0],g[1]*f[1]],A=this.getSizeAndScale(n,this.ctx.canvas.width,m[0]),_=this.getSizeAndScale(i,this.ctx.canvas.height,m[1]),b=e.cachedCanvases.getCanvas("pattern",A.size,_.size,!0),y=b.context,S=c.createCanvasGraphics(y)
return S.groupLevel=e.groupLevel,this.setFillAndStrokeStyleToContext(S,a,l),S.transform(A.scale,0,0,_.scale,0,0),S.transform(1,0,0,1,-h,-d),this.clipBbox(S,r,h,d,u,p),S.executeOperatorList(t),this.ctx.transform(1,0,0,1,h,d),this.ctx.scale(1/A.scale,1/_.scale),b.canvas},getSizeAndScale:function(e,t,r){e=Math.abs(e)
const s=Math.max(3e3,t)
let n=Math.ceil(e*r)
return n>=s?n=s:r=n/e,{scale:r,size:n}},clipBbox:function(e,t,r,s,n,i){if(Array.isArray(t)&&4===t.length){const t=n-r,a=i-s
e.ctx.rect(r,s,t,a),e.clip(),e.endPath()}},setFillAndStrokeStyleToContext:function(r,n,i){const a=r.ctx,o=r.current
switch(n){case e:const r=this.ctx
a.fillStyle=r.fillStyle,a.strokeStyle=r.strokeStyle,o.fillColor=r.fillStyle,o.strokeColor=r.strokeStyle
break
case t:const l=s.Util.makeHexColor(i[0],i[1],i[2])
a.fillStyle=l,a.strokeStyle=l,o.fillColor=l,o.strokeColor=l
break
...
t.TilingPattern=o},(e,t)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.GlobalWorkerOptions=void 0
...
this._metadataMap=new Map,t&&this._parse(t),this._data=e}_repair(e){return e.replace(/^[^<]+/,"").replace(/>\\376\\377([^<]+)/g,(function(e,t){const r=t.replace(/\\([0-3])([0-7])([0-7])/g,(function(e,t,r,s){return String.fromCharCode(64*t+8*r+1*s)})).replace(/&(amp|apos|gt|lt|quot);/g,(function(e,t){switch(t){case"amp":return"&"
case"apos":return"'"
case"gt":return">"
case"lt":return"<"
...
s+=e>=32&&e<127&&60!==e&&62!==e&&38!==e?String.fromCharCode(e):"&#x"+(65536+e).toString(16).substring(1)+";"}return">"+s}))}_getSequence(e){const t=e.nodeName
return"rdf:bag"!==t&&"rdf:seq"!==t&&"rdf:alt"!==t?null:e.childNodes.filter((e=>"rdf:li"===e.nodeName))}_getCreators(e){if("dc:creator"!==e.nodeName)return!1
if(!e.hasChildNodes())return!0
const t=e.childNodes[0],r=this._getSequence(t)||[]
return this._metadataMap.set(e.nodeName,r.map((e=>e.textContent.trim()))),!0}_parse(e){let t=e.documentElement
...
"#text"!==t&&(this._getCreators(e)||this._metadataMap.set(t,e.textContent.trim()))}}getRaw(){return this._data}get(e){return this._metadataMap.get(e)??null}getAll(){return(0,s.objectFromEntries)(this._metadataMap)}has(e){return this._metadataMap.has(e)}}},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.SimpleXMLParser=t.SimpleDOMNode=void 0
var s=r(2)
const n=0,i=-2,a=-3,o=-4,l=-5,c=-6,h=-9
function d(e,t){const r=e[t]
return" "===r||"\n"===r||"\r"===r||"\t"===r}class u{constructor(e,t){this.nodeName=e,this.nodeValue=t,Object.defineProperty(this,"parentNode",{value:null,writable:!0})}get firstChild(){return this.childNodes&&this.childNodes[0]}get nextSibling(){const e=this.parentNode.childNodes
if(!e)return
...
const r=e[t],s=[]
let n=this
for(;;){if(r.name===n.nodeName){if(0!==r.pos){if(0===s.length)return null
{const[i]=s.pop()
let a=0
for(const s of i.childNodes)if(r.name===s.nodeName){if(a===r.pos)return s.searchNode(e,t+1)
a++}return n.searchNode(e,t+1)}}{const r=n.searchNode(e,t+1)
if(null!==r)return r}}if(n.childNodes&&0!==n.childNodes.length)s.push([n,0]),n=n.childNodes[0]
else{if(0===s.length)return null
for(;0!==s.length;){const[e,t]=s.pop(),r=t+1
if(r<e.childNodes.length){s.push([e,r]),n=e.childNodes[r]
break}}if(0===s.length)return null}}}dump(e){if("#text"!==this.nodeName){if(e.push(`<${this.nodeName}`),this.attributes)for(const t of this.attributes)e.push(` ${t.name}="${(0,s.encodeToXmlString)(t.value)}"`)
if(this.hasChildNodes()){e.push(">")
for(const t of this.childNodes)t.dump(e)
e.push(`</${this.nodeName}>`)}else this.nodeValue?e.push(`>${(0,s.encodeToXmlString)(this.nodeValue)}</${this.nodeName}>`):e.push("/>")}else e.push((0,s.encodeToXmlString)(this.nodeValue))}}t.SimpleDOMNode=u
...
let s=t
function n(){for(;s<e.length&&d(e,s);)++s}for(;s<e.length&&!d(e,s)&&">"!==e[s]&&"/"!==e[s];)++s
const i=e.substring(t,s)
for(n();s<e.length&&">"!==e[s]&&"/"!==e[s]&&"?"!==e[s];){n()
let t="",i=""
for(;s<e.length&&!d(e,s)&&"="!==e[s];)t+=e[s],++s
...
for(;r<e.length&&!d(e,r)&&">"!==e[r]&&"/"!==e[r];)++r
const s=e.substring(t,r);(function(){for(;r<e.length&&d(e,r);)++r})()
const n=r
...
if("<"===e[t]){++r
let t
switch(e[r]){case"/":if(++r,t=e.indexOf(">",r),t<0)return void this.onError(h)
this.onEndElement(e.substring(r,t)),r=t+1
break
case"?":++r
const s=this._parseProcessingInstruction(e,r)
if("?>"!==e.substring(r+s.parsed,r+s.parsed+2))return void this.onError(a)
this.onPi(s.name,s.value),r+=s.parsed+2
break
case"!":if("--"===e.substring(r+1,r+3)){if(t=e.indexOf("--\x3e",r+3),t<0)return void this.onError(l)
this.onComment(e.substring(r+3,t)),r=t+3}else if("[CDATA["===e.substring(r+1,r+8)){if(t=e.indexOf("]]>",r+8),t<0)return void this.onError(i)
this.onCdata(e.substring(r+8,t)),r=t+3}else{if("DOCTYPE"!==e.substring(r+1,r+8))return void this.onError(c)
{const s=e.indexOf("[",r+8)
let n=!1
if(t=e.indexOf(">",r+8),t<0)return void this.onError(o)
if(s>0&&t>s){if(t=e.indexOf("]>",r+8),t<0)return void this.onError(o)
n=!0}const i=e.substring(r+8,t+(n?1:0))
this.onDoctype(i),r=t+(n?2:1)}}break
default:const n=this._parseContent(e,r)
if(null===n)return void this.onError(c)
let d=!1
if("/>"===e.substring(r+n.parsed,r+n.parsed+2))d=!0
else if(">"!==e.substring(r+n.parsed,r+n.parsed+1))return void this.onError(h)
this.onBeginElement(n.name,n.attributes,d),r+=n.parsed+(d?2:1)}}else{for(;r<e.length&&"<"!==e[r];)r++
const s=e.substring(t,r)
this.onText(this._resolveEntities(s))}t=r}}onResolveEntity(e){return`&${e};`}onPi(e,t){}onComment(e){}onCdata(e){}onDoctype(e){}onText(e){}onBeginElement(e,t,r){}onEndElement(e){}onError(e){}}{constructor({hasAttributes:e=!1,lowerCaseName:t=!1}){super(),this._currentFragment=null,this._stack=null,this._errorCode=n,this._hasAttributes=e,this._lowerCaseName=t}parseFromString(e){if(this._currentFragment=[],this._stack=[],this._errorCode=n,this.parseXml(e),this._errorCode!==n)return
const[t]=this._currentFragment
return t?{documentElement:t}:void 0}onResolveEntity(e){switch(e){case"apos":return"'"}return super.onResolveEntity(e)}onText(e){if(function(e){for(let t=0,r=e.length;t<r;t++)if(!d(e,t))return!1
return!0}(e))return
const t=new u("#text",e)
this._currentFragment.push(t)}onCdata(e){const t=new u("#text",e)
this._currentFragment.push(t)}onBeginElement(e,t,r){this._lowerCaseName&&(e=e.toLowerCase())
const s=new u(e)
s.childNodes=[],this._hasAttributes&&(s.attributes=t),this._currentFragment.push(s),r||(this._stack.push(this._currentFragment),this._currentFragment=s.childNodes)}onEndElement(e){this._currentFragment=this._stack.pop()||[]
const t=this._currentFragment[this._currentFragment.length-1]
if(t)for(let r=0,s=t.childNodes.length;r<s;r++)t.childNodes[r].parentNode=t}onError(e){this._errorCode=e}}},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.OptionalContentConfig=void 0
var s=r(2)
...
for(const t of e.off)this._groups.get(t).visible=!1}}isVisible(e){if("OCG"===e.type)return this._groups.has(e.id)?this._groups.get(e.id).visible:((0,s.warn)(`Optional content group not found: ${e.id}`),!0)
if("OCMD"===e.type){if(e.expression&&(0,s.warn)("Visibility expression not supported yet."),!e.policy||"AnyOn"===e.policy){for(const t of e.ids){if(!this._groups.has(t))return(0,s.warn)(`Optional content group not found: ${t}`),!0
if(this._groups.get(t).visible)return!0}return!1}if("AllOn"===e.policy){for(const t of e.ids){if(!this._groups.has(t))return(0,s.warn)(`Optional content group not found: ${t}`),!0
if(!this._groups.get(t).visible)return!1}return!0}if("AnyOff"===e.policy){for(const t of e.ids){if(!this._groups.has(t))return(0,s.warn)(`Optional content group not found: ${t}`),!0
if(!this._groups.get(t).visible)return!0}return!1}if("AllOff"===e.policy){for(const t of e.ids){if(!this._groups.has(t))return(0,s.warn)(`Optional content group not found: ${t}`),!0
if(this._groups.get(t).visible)return!1}return!0}return(0,s.warn)(`Unknown optional content policy ${e.policy}.`),!0}return(0,s.warn)(`Unknown group type ${e.type}.`),!0}setVisibility(e,t=!0){this._groups.has(e)?this._groups.get(e).visible=!!t:(0,s.warn)(`Optional content group not found: ${e}`)}getOrder(){return this._groups.size?this._order?this._order.slice():Array.from(this._groups.keys()):null}getGroups(){return this._groups.size?(0,s.objectFromEntries)(this._groups):null}getGroup(e){return this._groups.get(e)||null}}},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.PDFDataTransportStream=void 0
var s=r(2)
...
else{const r=this._rangeReaders.some((function(r){return r._begin===e.begin&&(r._enqueue(t),!0)}));(0,s.assert)(r,"_onReceiveData - no `PDFDataTransportStreamRangeReader` instance found.")}}get _progressiveDataLength(){return this._fullRequestReader?._loaded??0}_onProgress(e){if(void 0===e.total){const t=this._rangeReaders[0]
...
const e=(0,s.createPromiseCapability)()
return this._requests.push(e),e.promise}cancel(e){this._done=!0,this._requests.forEach((function(e){e.resolve({value:void 0,done:!0})})),this._requests=[],this._stream._removeRangeReader(this)}}},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.WebGLContext=void 0
var s=r(2)
...
const n=function(){function e(e,t,r){const s=e.createShader(r)
e.shaderSource(s,t),e.compileShader(s)
if(!e.getShaderParameter(s,e.COMPILE_STATUS)){const t=e.getShaderInfoLog(s)
throw new Error("Error during shader compilation: "+t)}return s}function t(t,r){return e(t,r,t.VERTEX_SHADER)}function r(t,r){return e(t,r,t.FRAGMENT_SHADER)}function s(e,t){const r=e.createProgram()
for(let s=0,n=t.length;s<n;++s)e.attachShader(r,t[s])
e.linkProgram(r)
if(!e.getProgramParameter(r,e.LINK_STATUS)){const t=e.getProgramInfoLog(r)
throw new Error("Error during program linking: "+t)}return r}function n(e,t,r){e.activeTexture(r)
const s=e.createTexture()
return e.bindTexture(e.TEXTURE_2D,s),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,t),s}let i,a
function o(){i||(a=document.createElement("canvas"),i=a.getContext("webgl",{premultipliedalpha:!1}))}let l=null
let c=null
return{tryInitGL(){try{return o(),!!i}catch(e){}return!1},composeSMask:function(e,c,h){const d=e.width,u=e.height
l||function(){o()
const e=a
a=null
const n=i
...
const d=n.getAttribLocation(c,"a_texCoord"),u=n.getUniformLocation(c,"u_image"),p=n.getUniformLocation(c,"u_mask"),g=n.createBuffer()
...
const m=n(f,e,f.TEXTURE0),A=n(f,c,f.TEXTURE1),_=f.createBuffer()
return f.bindBuffer(f.ARRAY_BUFFER,_),f.bufferData(f.ARRAY_BUFFER,new Float32Array([0,0,d,0,0,u,0,u,d,0,d,u]),f.STATIC_DRAW),f.enableVertexAttribArray(p.positionLocation),f.vertexAttribPointer(p.positionLocation,2,f.FLOAT,!1,0,0),f.clearColor(0,0,0,0),f.enable(f.BLEND),f.blendFunc(f.ONE,f.ONE_MINUS_SRC_ALPHA),f.clear(f.COLOR_BUFFER_BIT),f.drawArrays(f.TRIANGLES,0,6),f.flush(),f.deleteTexture(m),f.deleteTexture(A),f.deleteBuffer(_),g},drawFigures:function(e,n,l,h,d){c||function(){o()
const e=a
a=null
const n=i
i=null
...
const u=c,p=u.canvas,g=u.gl
p.width=e,p.height=n,g.viewport(0,0,g.drawingBufferWidth,g.drawingBufferHeight),g.uniform2f(u.resolutionLocation,e,n)
let f=0
for(let t=0,r=h.length;t<r;t++)switch(h[t].type){case"lattice":f+=((h[t].coords.length/h[t].verticesPerRow|0)-1)*(h[t].verticesPerRow-1)*6
break
case"triangles":f+=h[t].coords.length}const m=new Float32Array(2*f),A=new Uint8Array(3*f),_=d.coords,b=d.colors
let y=0,S=0
for(let t=0,r=h.length;t<r;t++){const e=h[t],r=e.coords,s=e.colors
switch(e.type){case"lattice":const t=e.verticesPerRow,n=r.length/t|0
for(let e=1;e<n;e++){let n=e*t+1
for(let e=1;e<t;e++,n++){m[y]=_[r[n-t-1]],m[y+1]=_[r[n-t-1]+1],m[y+2]=_[r[n-t]],m[y+3]=_[r[n-t]+1],m[y+4]=_[r[n-1]],m[y+5]=_[r[n-1]+1],A[S]=b[s[n-t-1]],A[S+1]=b[s[n-t-1]+1],A[S+2]=b[s[n-t-1]+2],A[S+3]=b[s[n-t]],A[S+4]=b[s[n-t]+1],A[S+5]=b[s[n-t]+2],A[S+6]=b[s[n-1]],A[S+7]=b[s[n-1]+1],A[S+8]=b[s[n-1]+2],m[y+6]=m[y+2],m[y+7]=m[y+3],m[y+8]=m[y+4],m[y+9]=m[y+5],m[y+10]=_[r[n]],m[y+11]=_[r[n]+1],A[S+9]=A[S+3],A[S+10]=A[S+4],A[S+11]=A[S+5],A[S+12]=A[S+6],A[S+13]=A[S+7],A[S+14]=A[S+8],A[S+15]=b[s[n]],A[S+16]=b[s[n]+1],A[S+17]=b[s[n]+2]
y+=12,S+=18}}break
case"triangles":for(let e=0,i=r.length;e<i;e++)m[y]=_[r[e]],m[y+1]=_[r[e]+1],A[S]=b[s[e]],A[S+1]=b[s[e]+1],A[S+2]=b[s[e]+2],y+=2,S+=3}}l?g.clearColor(l[0]/255,l[1]/255,l[2]/255,1):g.clearColor(0,0,0,0),g.clear(g.COLOR_BUFFER_BIT)
const v=g.createBuffer()
g.bindBuffer(g.ARRAY_BUFFER,v),g.bufferData(g.ARRAY_BUFFER,m,g.STATIC_DRAW),g.enableVertexAttribArray(u.positionLocation),g.vertexAttribPointer(u.positionLocation,2,g.FLOAT,!1,0,0)
const C=g.createBuffer()
return g.bindBuffer(g.ARRAY_BUFFER,C),g.bufferData(g.ARRAY_BUFFER,A,g.STATIC_DRAW),g.enableVertexAttribArray(u.colorLocation),g.vertexAttribPointer(u.colorLocation,3,g.UNSIGNED_BYTE,!1,0,0),g.uniform2f(u.scaleLocation,d.scaleX,d.scaleY),g.uniform2f(u.offsetLocation,d.offsetX,d.offsetY),g.drawArrays(g.TRIANGLES,0,f),g.flush(),g.deleteBuffer(v),g.deleteBuffer(C),p},cleanup(){l?.canvas&&(l.canvas.width=0,l.canvas.height=0),c?.canvas&&(c.canvas.width=0,c.canvas.height=0),l=null,c=null}}}()},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.AnnotationLayer=void 0
var s=r(1),n=r(2),i=r(8),a=r(20)
...
case n.AnnotationType.POPUP:return new A(e)
...
case n.AnnotationType.POLYLINE:return new C(e)
case n.AnnotationType.CARET:return new k(e)
case n.AnnotationType.INK:return new P(e)
case n.AnnotationType.POLYGON:return new x(e)
...
for(const s of this.data.quadPoints)this.data.rect=[s[2].x,s[2].y,s[1].x,s[1].y],t.push(this._createContainer(e))
...
const s=new _({container:r,trigger:e,color:t.color,title:t.title,modificationDate:t.modificationDate,contents:t.contents,hideWrapper:!0}).render()
s.style.left=r.style.width,r.appendChild(s)}_renderQuadrilaterals(e){return this.quadrilaterals.forEach((t=>{t.className=e})),this.quadrilaterals}render(){(0,n.unreachable)("Abstract method `AnnotationElement.render` called")}}class c extends l{constructor(e){super(e,{isRenderable:!!(e.data.url||e.data.dest||e.data.action||e.data.isTooltipOnly||e.data.actions&&(e.data.actions.Action||e.data.actions["Mouse Up"]||e.data.actions["Mouse Down"])),createQuadrilaterals:!0})}render(){const{data:e,linkService:t}=this,r=document.createElement("a")
return e.url?(0,s.addLinkAttributes)(r,{url:e.url,target:e.newWindow?s.LinkTarget.BLANK:t.externalLinkTarget,rel:t.externalLinkRel,enabled:t.externalLinkEnabled}):e.action?this._bindNamedAction(r,e.action):e.dest?this._bindLink(r,e.dest):e.actions&&(e.actions.Action||e.actions["Mouse Up"]||e.actions["Mouse Down"])&&this.enableScripting&&this.hasJSActions?this._bindJSAction(r,e):this._bindLink(r,""),this.quadrilaterals?this._renderQuadrilaterals("linkAnnotation").map(((e,t)=>{const s=0===t?r:r.cloneNode()
return e.appendChild(s),e})):(this.container.className="linkAnnotation",this.container.appendChild(r),this.container)}_bindLink(e,t){e.href=this.linkService.getDestinationHash(t),e.onclick=()=>(t&&this.linkService.goToDestination(t),!1),(t||""===t)&&(e.className="internalLink")}_bindNamedAction(e,t){e.href=this.linkService.getAnchorUrl(""),e.onclick=()=>(this.linkService.executeNamedAction(t),!1),e.className="internalLink"}_bindJSAction(e,t){e.href=this.linkService.getAnchorUrl("")
const r=new Map([["Action","onclick"],["Mouse Up","onmouseup"],["Mouse Down","onmousedown"]])
for(const s of Object.keys(t.actions)){const n=r.get(s)
n&&(e[n]=()=>(this.linkService.eventBus?.dispatch("dispatcheventinsandbox",{source:this,detail:{id:t.id,name:s}}),!1))}e.className="internalLink"}}class h extends l{constructor(e){super(e,{isRenderable:!!(e.data.hasPopup||e.data.title||e.data.contents)})}render(){this.container.className="textAnnotation"
const e=document.createElement("img")
return e.style.height=this.container.style.height,e.style.width=this.container.style.width,e.src=this.imageResourcesPath+"annotation-"+this.data.name.toLowerCase()+".svg",e.alt="[{{type}} Annotation]",e.dataset.l10nId="text_annotation_type",e.dataset.l10nArgs=JSON.stringify({type:this.data.name}),this.data.hasPopup||this._createPopup(e,this.data),this.container.appendChild(e),this.container}}class d extends l{render(){return this.data.alternativeText&&(this.container.title=this.data.alternativeText),this.container}_getKeyModifier(e){return navigator.platform.includes("Win")&&e.ctrlKey||navigator.platform.includes("Mac")&&e.metaKey}_setEventListener(e,t,r,s){t.includes("mouse")?e.addEventListener(t,(e=>{this.linkService.eventBus?.dispatch("dispatcheventinsandbox",{source:this,detail:{id:this.data.id,name:r,value:s(e),shift:e.shiftKey,modifier:this._getKeyModifier(e)}})})):e.addEventListener(t,(e=>{this.linkService.eventBus?.dispatch("dispatcheventinsandbox",{source:this,detail:{id:this.data.id,name:r,value:e.target.checked}})}))}_setEventListeners(e,t,r){for(const[s,n]of t)("Action"===n||this.data.actions?.[n])&&this._setEventListener(e,s,n,r)}}class u extends d{constructor(e){super(e,{isRenderable:e.renderInteractiveForms||!e.data.hasAppearance&&!!e.data.fieldValue})}render(){const e=this.annotationStorage,t=this.data.id
this.container.className="textWidgetAnnotation"
let r=null
if(this.renderInteractiveForms){const s=e.getOrCreateValue(t,{value:this.data.fieldValue}).value,n={userValue:null,formattedValue:null,beforeInputSelectionRange:null,beforeInputValue:null}
this.data.multiLine?(r=document.createElement("textarea"),r.textContent=s):(r=document.createElement("input"),r.type="text",r.setAttribute("value",s)),n.userValue=s,r.setAttribute("id",t),r.addEventListener("input",(function(r){e.setValue(t,{value:r.target.value})}))
let i=e=>{n.formattedValue&&(e.target.value=n.formattedValue),e.target.setSelectionRange(0,0),n.beforeInputSelectionRange=null}
if(this.enableScripting&&this.hasJSActions&&(r.addEventListener("focus",(e=>{n.userValue&&(e.target.value=n.userValue)})),r.addEventListener("updatefromsandbox",(function(r){const{detail:s}=r,i={value(){n.userValue=s.value||"",e.setValue(t,{value:n.userValue.toString()}),n.formattedValue||(r.target.value=n.userValue)},valueAsString(){n.formattedValue=s.valueAsString||"",r.target!==document.activeElement&&(r.target.value=n.formattedValue),e.setValue(t,{formattedValue:n.formattedValue})},focus(){setTimeout((()=>r.target.focus({preventScroll:!1})),0)},userName(){r.target.title=s.userName},hidden(){r.target.style.visibility=s.hidden?"hidden":"visible",e.setValue(t,{hidden:s.hidden})},editable(){r.target.disabled=!s.editable},selRange(){const[e,t]=s.selRange
e>=0&&t<r.target.value.length&&r.target.setSelectionRange(e,t)},strokeColor(){const e=s.strokeColor
r.target.style.color=a.ColorConverters[`${e[0]}_HTML`](e.slice(1))}}
Object.keys(s).filter((e=>e in i)).forEach((e=>i[e]()))})),this.data.actions)){r.addEventListener("keydown",(e=>{n.beforeInputValue=e.target.value
let r=-1
"Escape"===e.key?r=0:"Enter"===e.key?r=2:"Tab"===e.key&&(r=3),-1!==r&&(n.userValue=e.target.value,this.linkService.eventBus?.dispatch("dispatcheventinsandbox",{source:this,detail:{id:t,name:"Keystroke",value:e.target.value,willCommit:!0,commitKey:r,selStart:e.target.selectionStart,selEnd:e.target.selectionEnd}}))}))
const e=i
i=null,r.addEventListener("blur",(r=>{this._mouseState.isDown&&(n.userValue=r.target.value,this.linkService.eventBus?.dispatch("dispatcheventinsandbox",{source:this,detail:{id:t,name:"Keystroke",value:r.target.value,willCommit:!0,commitKey:1,selStart:r.target.selectionStart,selEnd:r.target.selectionEnd}})),e(r)})),r.addEventListener("mousedown",(e=>{n.beforeInputValue=e.target.value,n.beforeInputSelectionRange=null})),r.addEventListener("keyup",(e=>{e.target.selectionStart===e.target.selectionEnd&&(n.beforeInputSelectionRange=null)})),r.addEventListener("select",(e=>{n.beforeInputSelectionRange=[e.target.selectionStart,e.target.selectionEnd]})),"Keystroke"in this.data.actions&&r.addEventListener("input",(e=>{let r=-1,s=-1
n.beforeInputSelectionRange&&([r,s]=n.beforeInputSelectionRange),this.linkService.eventBus?.dispatch("dispatcheventinsandbox",{source:this,detail:{id:t,name:"Keystroke",value:n.beforeInputValue,change:e.data,willCommit:!1,selStart:r,selEnd:s}})})),this._setEventListeners(r,[["focus","Focus"],["blur","Blur"],["mousedown","Mouse Down"],["mouseenter","Mouse Enter"],["mouseleave","Mouse Exit"],["mouseup","Mouse Up"]],(e=>e.target.value))}if(i&&r.addEventListener("blur",i),r.disabled=this.data.readOnly,r.name=this.data.fieldName,null!==this.data.maxLen&&(r.maxLength=this.data.maxLen),this.data.comb){const e=(this.data.rect[2]-this.data.rect[0])/this.data.maxLen
...
return this._setTextStyle(r),this.container.appendChild(r),this.container}_setTextStyle(e){const t=["left","center","right"],{fontSize:r,fontColor:s}=this.data.defaultAppearanceData,i=e.style
r&&(i.fontSize=`${r}px`),i.color=n.Util.makeHexColor(s[0],s[1],s[2]),null!==this.data.textAlignment&&(i.textAlign=t[this.data.textAlignment])}}class p extends d{constructor(e){super(e,{isRenderable:e.renderInteractiveForms})}render(){const e=this.annotationStorage,t=this.data,r=t.id,s=e.getOrCreateValue(r,{value:t.fieldValue&&"Off"!==t.fieldValue}).value
this.container.className="buttonWidgetAnnotation checkBox"
const n=document.createElement("input")
return n.disabled=t.readOnly,n.type="checkbox",n.name=this.data.fieldName,s&&n.setAttribute("checked",!0),n.setAttribute("id",r),n.addEventListener("change",(function(t){const s=t.target.name
for(const r of document.getElementsByName(s))r!==t.target&&(r.checked=!1,e.setValue(r.parentNode.getAttribute("data-annotation-id"),{value:!1}))
e.setValue(r,{value:t.target.checked})})),this.enableScripting&&this.hasJSActions&&(n.addEventListener("updatefromsandbox",(t=>{const{detail:s}=t,n={value(){t.target.checked="Off"!==s.value,e.setValue(r,{value:t.target.checked})},focus(){setTimeout((()=>t.target.focus({preventScroll:!1})),0)},hidden(){t.target.style.visibility=s.hidden?"hidden":"visible",e.setValue(r,{hidden:s.hidden})},editable(){t.target.disabled=!s.editable}}
Object.keys(s).filter((e=>e in n)).forEach((e=>n[e]()))})),this._setEventListeners(n,[["change","Validate"],["change","Action"],["focus","Focus"],["blur","Blur"],["mousedown","Mouse Down"],["mouseenter","Mouse Enter"],["mouseleave","Mouse Exit"],["mouseup","Mouse Up"]],(e=>e.target.checked))),this.container.appendChild(n),this.container}}class g extends d{constructor(e){super(e,{isRenderable:e.renderInteractiveForms})}render(){this.container.className="buttonWidgetAnnotation radioButton"
const e=this.annotationStorage,t=this.data,r=t.id,s=e.getOrCreateValue(r,{value:t.fieldValue===t.buttonValue}).value,n=document.createElement("input")
return n.disabled=t.readOnly,n.type="radio",n.name=t.fieldName,s&&n.setAttribute("checked",!0),n.setAttribute("pdfButtonValue",t.buttonValue),n.setAttribute("id",r),n.addEventListener("change",(function(t){const{target:s}=t
for(const r of document.getElementsByName(s.name))r!==s&&e.setValue(r.getAttribute("id"),{value:!1})
e.setValue(r,{value:s.checked})})),this.enableScripting&&this.hasJSActions&&(n.addEventListener("updatefromsandbox",(t=>{const{detail:s}=t,n={value(){const r=s.value
for(const s of document.getElementsByName(t.target.name)){const t=s.getAttribute("id")
r===s.getAttribute("pdfButtonValue")?(s.setAttribute("checked",!0),e.setValue(t,{value:!0})):e.setValue(t,{value:!1})}},focus(){setTimeout((()=>t.target.focus({preventScroll:!1})),0)},hidden(){t.target.style.visibility=s.hidden?"hidden":"visible",e.setValue(r,{hidden:s.hidden})},editable(){t.target.disabled=!s.editable}}
Object.keys(s).filter((e=>e in n)).forEach((e=>n[e]()))})),this._setEventListeners(n,[["change","Validate"],["change","Action"],["focus","Focus"],["blur","Blur"],["mousedown","Mouse Down"],["mouseenter","Mouse Enter"],["mouseleave","Mouse Exit"],["mouseup","Mouse Up"]],(e=>e.target.checked))),this.container.appendChild(n),this.container}}class f extends c{render(){const e=super.render()
...
for(const n of this.data.options){const e=document.createElement("option")
e.textContent=n.displayValue,e.value=n.exportValue,this.data.fieldValue.includes(n.exportValue)&&e.setAttribute("selected",!0),r.appendChild(e)}function s(e){const t=e.target.options
return t[t.selectedIndex].value}return this.enableScripting&&this.hasJSActions?(r.addEventListener("updatefromsandbox",(r=>{const{detail:s}=r,n={value(){const n=r.target.options,i=s.value,a=n.indexOf(i);-1!==a&&(n.selectedIndex=a,e.setValue(t,{value:i}))},focus(){setTimeout((()=>r.target.focus({preventScroll:!1})),0)},hidden(){r.target.style.visibility=s.hidden?"hidden":"visible",e.setValue(t,{hidden:s.hidden})},editable(){r.target.disabled=!s.editable}}
Object.keys(s).filter((e=>e in n)).forEach((e=>n[e]()))})),r.addEventListener("input",(r=>{const n=s(r)
e.setValue(t,{value:n}),this.linkService.eventBus?.dispatch("dispatcheventinsandbox",{source:this,detail:{id:t,name:"Keystroke",changeEx:n,willCommit:!0,commitKey:1,keyDown:!1}})})),this._setEventListeners(r,[["focus","Focus"],["blur","Blur"],["mousedown","Mouse Down"],["mouseenter","Mouse Enter"],["mouseleave","Mouse Exit"],["mouseup","Mouse Up"]],(e=>e.target.checked))):r.addEventListener("input",(function(r){e.setValue(t,{value:s(r)})})),this.container.appendChild(r),this.container}}class A extends l{constructor(e){super(e,{isRenderable:!(!e.data.title&&!e.data.contents)})}render(){if(this.container.className="popupAnnotation",["Line","Square","Circle","PolyLine","Polygon","Ink"].includes(this.data.parentType))return this.container
const e=`[data-annotation-id="${this.data.parentId}"]`,t=this.layer.querySelectorAll(e)
if(0===t.length)return this.container
const r=new _({container:this.container,trigger:Array.from(t),color:this.data.color,title:this.data.title,modificationDate:this.data.modificationDate,contents:this.data.contents}),s=this.page,i=n.Util.normalizeRect([this.data.parentRect[0],s.view[3]-this.data.parentRect[1]+s.view[1],this.data.parentRect[2],s.view[3]-this.data.parentRect[3]+s.view[1]]),a=i[0]+this.data.parentRect[2]-this.data.parentRect[0],o=i[1]
return this.container.style.transformOrigin=`${-a}px ${-o}px`,this.container.style.left=`${a}px`,this.container.style.top=`${o}px`,this.container.appendChild(r.render()),this.container}}class _{constructor(e){this.container=e.container,this.trigger=e.trigger,this.color=e.color,this.title=e.title,this.modificationDate=e.modificationDate,this.contents=e.contents,this.hideWrapper=e.hideWrapper||!1,this.pinned=!1}render(){const e=document.createElement("div")
...
t.style.backgroundColor=n.Util.makeHexColor(0|e,0|s,0|i)}const i=document.createElement("h1")
...
return t.appendChild(o),Array.isArray(this.trigger)||(this.trigger=[this.trigger]),this.trigger.forEach((e=>{e.addEventListener("click",this._toggle.bind(this)),e.addEventListener("mouseover",this._show.bind(this,!1)),e.addEventListener("mouseout",this._hide.bind(this,!1))})),t.addEventListener("click",this._hide.bind(this,!0)),e.appendChild(t),e}_formatContents(e){const t=document.createElement("p"),r=e.split(/(?:\r\n?|\n)/)
...
this.filename=(0,s.getFilenameFromUrl)(t),this.content=r,this.linkService.eventBus?.dispatch("fileattachmentannotation",{source:this,id:(0,n.stringToPDFString)(t),filename:t,content:r})}render(){this.container.className="fileAttachmentAnnotation"
const e=document.createElement("div")
...
r.length&&t.push(...r)
for(const n of t){const t=o.create({data:n,layer:e.div,page:e.page,viewport:e.viewport,linkService:e.linkService,downloadManager:e.downloadManager,imageResourcesPath:e.imageResourcesPath||"",renderInteractiveForms:"boolean"!=typeof e.renderInteractiveForms||e.renderInteractiveForms,svgFactory:new s.DOMSVGFactory,annotationStorage:e.annotationStorage||new i.AnnotationStorage,enableScripting:e.enableScripting,hasJSActions:e.hasJSActions,mouseState:e.mouseState||{isDown:!1}})
...
else t instanceof A?e.div.prepend(r):e.div.appendChild(r)}}}static update(e){const t=`matrix(${e.viewport.transform.join(",")})`
for(const r of e.annotations){const s=e.div.querySelectorAll(`[data-annotation-id="${r.id}"]`)
s&&s.forEach((e=>{e.style.transform=t}))}e.div.removeAttribute("hidden")}}},(e,t)=>{function r(e){return Math.floor(255*Math.max(0,Math.min(1,e))).toString(16).padStart(2,"0")}Object.defineProperty(t,"__esModule",{value:!0}),t.ColorConverters=void 0
t.ColorConverters=class{static CMYK_G([e,t,r,s]){return["G",1-Math.min(1,.3*e+.59*r+.11*t+s)]}static G_CMYK([e]){return["CMYK",0,0,0,1-e]}static G_RGB([e]){return["RGB",e,e,e]}static G_HTML([e]){const t=r(e)
return`#${t}${t}${t}`}static RGB_G([e,t,r]){return["G",.3*e+.59*t+.11*r]}static RGB_HTML([e,t,s]){return`#${r(e)}${r(t)}${r(s)}`}static T_HTML(){return"#00000000"}static CMYK_RGB([e,t,r,s]){return["RGB",1-Math.min(1,e+s),1-Math.min(1,r+s),1-Math.min(1,t+s)]}static CMYK_HTML(e){return this.RGB_HTML(this.CMYK_RGB(e))}static RGB_CMYK([e,t,r]){const s=1-e,n=1-t,i=1-r
return["CMYK",s,n,i,Math.min(s,n,i)]}}},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.renderTextLayer=void 0
var s=r(2)
const n=function(){const e=/\S/
function t(t,r,n){const i=document.createElement("span"),a={angle:0,canvasWidth:0,isWhitespace:!1,originalTransform:null,paddingBottom:0,paddingLeft:0,paddingRight:0,paddingTop:0,scale:1}
if(t._textDivs.push(i),o=r.str,!e.test(o))return a.isWhitespace=!0,void t._textDivProperties.set(i,a)
var o
const l=s.Util.transform(t._viewport.transform,r.transform)
let c=Math.atan2(l[1],l[0])
const h=n[r.fontName]
h.vertical&&(c+=Math.PI/2)
const d=Math.sqrt(l[2]*l[2]+l[3]*l[3])
let u,p,g=d
h.ascent?g=h.ascent*g:h.descent&&(g=(1+h.descent)*g),0===c?(u=l[4],p=l[5]-g):(u=l[4]+g*Math.sin(c),p=l[5]-g*Math.cos(c)),i.style.left=`${u}px`,i.style.top=`${p}px`,i.style.fontSize=`${d}px`,i.style.fontFamily=h.fontFamily,i.textContent=r.str,t._fontInspectorEnabled&&(i.dataset.fontName=r.fontName),0!==c&&(a.angle=c*(180/Math.PI))
let f=!1
if(r.str.length>1)f=!0
else if(r.transform[0]!==r.transform[3]){const e=Math.abs(r.transform[0]),t=Math.abs(r.transform[3])
e!==t&&Math.max(e,t)/Math.min(e,t)>1.5&&(f=!0)}if(f&&(h.vertical?a.canvasWidth=r.height*t._viewport.scale:a.canvasWidth=r.width*t._viewport.scale),t._textDivProperties.set(i,a),t._textContentStream&&t._layoutText(i),t._enhanceTextSelection){let e=1,n=0
0!==c&&(e=Math.cos(c),n=Math.sin(c))
const a=(h.vertical?r.height:r.width)*t._viewport.scale,o=d
let l,g
0!==c?(l=[e,n,-n,e,u,p],g=s.Util.getAxialAlignedBoundingBox([0,0,a,o],l)):g=[u,p,u+a,p+o],t._bounds.push({left:g[0],top:g[1],right:g[2],bottom:g[3],div:i,size:[a,o],m:l})}}function r(e){if(e._canceled)return
const t=e._textDivs,r=e._capability,s=t.length
if(s>1e5)return e._renderingDone=!0,void r.resolve()
if(!e._textContentStream)for(let n=0;n<s;n++)e._layoutText(t[n])
e._renderingDone=!0,r.resolve()}function n(e,t,r){let s=0
for(let n=0;n<r;n++){const r=e[t++]
r>0&&(s=s?Math.min(r,s):r)}return s}function i(e){const t=e._bounds,r=e._viewport,i=function(e,t,r){const s=r.map((function(e,t){return{x1:e.left,y1:e.top,x2:e.right,y2:e.bottom,index:t,x1New:void 0,x2New:void 0}}))
a(e,s)
const n=new Array(r.length)
return s.forEach((function(e){const t=e.index
n[t]={left:e.x1New,top:0,right:e.x2New,bottom:0}})),r.map((function(t,r){const i=n[r],a=s[r]
a.x1=t.top,a.y1=e-i.right,a.x2=t.bottom,a.y2=e-i.left,a.index=r,a.x1New=void 0,a.x2New=void 0})),a(t,s),s.forEach((function(e){const t=e.index
n[t].top=e.x1New,n[t].bottom=e.x2New})),n}(r.width,r.height,t)
for(let a=0;a<i.length;a++){const r=t[a].div,o=e._textDivProperties.get(r)
if(0===o.angle){o.paddingLeft=t[a].left-i[a].left,o.paddingTop=t[a].top-i[a].top,o.paddingRight=i[a].right-t[a].right,o.paddingBottom=i[a].bottom-t[a].bottom,e._textDivProperties.set(r,o)
continue}const l=i[a],c=t[a],h=c.m,d=h[0],u=h[1],p=[[0,0],[0,c.size[1]],[c.size[0],0],c.size],g=new Float64Array(64)
p.forEach((function(e,t){const r=s.Util.applyTransform(e,h)
g[t+0]=d&&(l.left-r[0])/d,g[t+4]=u&&(l.top-r[1])/u,g[t+8]=d&&(l.right-r[0])/d,g[t+12]=u&&(l.bottom-r[1])/u,g[t+16]=u&&(l.left-r[0])/-u,g[t+20]=d&&(l.top-r[1])/d,g[t+24]=u&&(l.right-r[0])/-u,g[t+28]=d&&(l.bottom-r[1])/d,g[t+32]=d&&(l.left-r[0])/-d,g[t+36]=u&&(l.top-r[1])/-u,g[t+40]=d&&(l.right-r[0])/-d,g[t+44]=u&&(l.bottom-r[1])/-u,g[t+48]=u&&(l.left-r[0])/u,g[t+52]=d&&(l.top-r[1])/-d,g[t+56]=u&&(l.right-r[0])/u,g[t+60]=d&&(l.bottom-r[1])/-d}))
const f=1+Math.min(Math.abs(d),Math.abs(u))
o.paddingLeft=n(g,32,16)/f,o.paddingTop=n(g,48,16)/f,o.paddingRight=n(g,0,16)/f,o.paddingBottom=n(g,16,16)/f,e._textDivProperties.set(r,o)}}function a(e,t){t.sort((function(e,t){return e.x1-t.x1||e.index-t.index}))
...
let s,n,i=r.length-1
for(;i>=0&&r[i].start>=e.y2;)i--
let a,o,l=-1/0
for(a=t;a<=i;a++){let t
s=r[a],n=s.boundary,t=n.x2>e.x1?n.index>e.index?n.x1New:e.x1:void 0===n.x2New?(n.x2+e.x1)/2:n.x2New,t>l&&(l=t)}for(e.x1New=l,a=t;a<=i;a++)s=r[a],n=s.boundary,void 0===n.x2New?n.x2>e.x1?n.index>e.index&&(n.x2New=n.x2):n.x2New=l:n.x2New>l&&(n.x2New=Math.max(l,n.x2))
const c=[]
let h=null
for(a=t;a<=i;a++){s=r[a],n=s.boundary
const t=n.x2>e.x2?n:e
h===t?c[c.length-1].end=s.end:(c.push({start:s.start,end:s.end,boundary:t}),h=t)}for(r[t].start<e.y1&&(c[0].start=e.y1,c.unshift({start:r[t].start,end:e.y1,boundary:r[t].boundary})),e.y2<r[i].end&&(c[c.length-1].end=e.y2,c.push({start:e.y2,end:r[i].end,boundary:r[i].boundary})),a=t;a<=i;a++){if(s=r[a],n=s.boundary,void 0!==n.x2New)continue
let e=!1
for(o=t-1;!e&&o>=0&&r[o].start>=n.y1;o--)e=r[o].boundary===n
for(o=i+1;!e&&o<r.length&&r[o].end<=n.y2;o++)e=r[o].boundary===n
for(o=0;!e&&o<c.length;o++)e=c[o].boundary===n
e||(n.x2New=l)}Array.prototype.splice.apply(r,[t,i-t+1].concat(c))})),r.forEach((function(t){const r=t.boundary
void 0===r.x2New&&(r.x2New=Math.max(e,r.x2))}))}function o({textContent:e,textContentStream:t,container:r,viewport:n,textDivs:i,textContentItemsStr:a,enhanceTextSelection:o}){this._textContent=e,this._textContentStream=t,this._container=r,this._document=r.ownerDocument,this._viewport=n,this._textDivs=i||[],this._textContentItemsStr=a||[],this._enhanceTextSelection=!!o,this._fontInspectorEnabled=!!globalThis.FontInspector?.enabled,this._reader=null,this._layoutTextLastFontSize=null,this._layoutTextLastFontFamily=null,this._layoutTextCtx=null,this._textDivProperties=new WeakMap,this._renderingDone=!1,this._canceled=!1,this._capability=(0,s.createPromiseCapability)(),this._renderTimer=null,this._bounds=[],this._capability.promise.finally((()=>{this._layoutTextCtx&&(this._layoutTextCtx.canvas.width=0,this._layoutTextCtx.canvas.height=0,this._layoutTextCtx=null)})).catch((()=>{}))}return o.prototype={get promise(){return this._capability.promise},cancel:function(){this._canceled=!0,this._reader&&(this._reader.cancel(new s.AbortException("TextLayer task cancelled.")),this._reader=null),null!==this._renderTimer&&(clearTimeout(this._renderTimer),this._renderTimer=null),this._capability.reject(new Error("TextLayer task cancelled."))},_processItems(e,r){for(let s=0,n=e.length;s<n;s++)this._textContentItemsStr.push(e[s].str),t(this,e[s],r)},_layoutText(e){const t=this._textDivProperties.get(e)
...
const t=[],r=[]
for(let s=0,n=this._textDivs.length;s<n;s++){const n=this._textDivs[s],i=this._textDivProperties.get(n)
i.isWhitespace||(e?(t.length=0,r.length=0,i.originalTransform&&t.push(i.originalTransform),i.paddingTop>0?(r.push(`${i.paddingTop}px`),t.push(`translateY(${-i.paddingTop}px)`)):r.push(0),i.paddingRight>0?r.push(i.paddingRight/i.scale+"px"):r.push(0),i.paddingBottom>0?r.push(`${i.paddingBottom}px`):r.push(0),i.paddingLeft>0?(r.push(i.paddingLeft/i.scale+"px"),t.push(`translateX(${-i.paddingLeft/i.scale}px)`)):r.push(0),n.style.padding=r.join(" "),t.length&&(n.style.transform=t.join(" "))):(n.style.padding=null,n.style.transform=i.originalTransform))}}},function(e){const t=new o({textContent:e.textContent,textContentStream:e.textContentStream,container:e.container,viewport:e.viewport,textDivs:e.textDivs,textContentItemsStr:e.textContentItemsStr,enhanceTextSelection:e.enhanceTextSelection})
return t._render(e.timeout),t}}()
t.renderTextLayer=n},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.SVGGraphics=void 0
...
for(let e=0;e<h;e++){m++
for(let e=0;e<p;e++)f[m++]^=255}}const _=new Uint8Array([c>>24&255,c>>16&255,c>>8&255,255&c,h>>24&255,h>>16&255,h>>8&255,255&h,d,u,0,0,0]),b=function(e){if(!i.isNodeJS)return n(e)
try{let t
t=parseInt(process.versions.node)>=8?e:Buffer.from(e)
const r=require("zlib").deflateSync(t,{level:9})
return r instanceof Uint8Array?r:new Uint8Array(r)}catch(t){(0,s.warn)("Not compressing PNG because zlib.deflateSync is unavailable: "+t)}return n(e)}(f),y=e.length+36+_.length+b.length,S=new Uint8Array(y)
let v=0
return S.set(e,v),v+=e.length,r("IHDR",_,S,v),v+=12+_.length,r("IDATA",b,S,v),v+=12+b.length,r("IEND",new Uint8Array(0),S,v),(0,s.createObjectURL)(S,"image/png",o)}return function(e,t,r){return a(e,void 0===e.kind?s.ImageKind.GRAYSCALE_1BPP:e.kind,t,r)}}()
...
let n=e[1]
t.font=r,!this.embedFonts||r.missingFile||this.embeddedFonts[r.loadedName]||(this.addFontStyle(r),this.embeddedFonts[r.loadedName]=r),t.fontMatrix=r.fontMatrix||s.FONT_IDENTITY_MATRIX
let i="normal"
...
const C=this.svg,x=this.transformMatrix,k=this.current.fillColor,P=this.current.strokeColor,w=this.svgFactory.create(f-p,A-g)
if(this.svg=w,this.transformMatrix=n,2===d){const e=s.Util.makeHexColor(...t)
...
c.test(this._url.href)&&(s=s.replace(/^\//,"")),this._setReadableStream(i.createReadStream(s,{start:t,end:r-1}))}}},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.createResponseStatusError=function(e,t){if(404===e||0===e&&t.startsWith("file:"))return new s.MissingPDFException('Missing PDF "'+t+'".')
...
var s=r(2),n=r(25)},(e,t)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.getFilenameFromContentDispositionHeader=function(e){let t=!0,r=s("filename\\*","i").exec(e)
if(r){r=r[1]
let e=a(r)
...
try{s=atob(s)}catch(i){}return n(t,s)}))}return""}},(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.PDFNetworkStream=void 0
var s=r(2),n=r(24)
...
r.onDone({begin:parseInt(t[1],10),chunk:a})}else a?r.onDone({begin:0,chunk:a}):r.onError&&r.onError(n.status)}getRequestXhr(e){return this.pendingRequests[e].xhr}isPendingRequest(e){return e in this.pendingRequests}abortRequest(e){const t=this.pendingRequests[e].xhr
...
var s=r(2),n=r(24)
function i(e,t,r){return{method:"GET",headers:e,signal:r?.signal,mode:"cors",credentials:t?"include":"same-origin",redirect:"follow"}}function a(e){const t=new Headers
...
return{value:new Uint8Array(e).buffer,done:!1}}cancel(e){this._reader&&this._reader.cancel(e),this._abortController&&this._abortController.abort()}}}],__webpack_module_cache__={}
function __w_pdfjs_require__(e){if(__webpack_module_cache__[e])return __webpack_module_cache__[e].exports
var t=__webpack_module_cache__[e]={exports:{}}
return __webpack_modules__[e](t,t.exports,__w_pdfjs_require__),t.exports}return __w_pdfjs_require__(0)})()}))
