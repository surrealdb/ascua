...
var s=r(1),n=r(5),i=r(2),a=r(19),o=r(9),l=r(12),c=r(20),h=r(21)
{const{isNodeJS:e}=r(4)
if(e){const e=r(22).PDFNodeStream;(0,n.setPDFNetworkStreamFactory)((t=>new e(t)))}else{const e=r(25).PDFNetworkStream
let t;(0,s.isFetchSupported)()&&(t=r(26).PDFFetchStream),(0,n.setPDFNetworkStreamFactory)((r=>t&&(0,s.isValidFetchUrl)(r.url)?new t(r):new e(r)))}}},function(e,t,r){"use strict"
...
break
case h.TOP:l="_top"}e.target=l,e.rel="string"==typeof i?i:n},t.getFilenameFromUrl=function(e){const t=e.indexOf("#"),r=e.indexOf("?"),s=Math.min(t>0?t:e.length,r>0?r:e.length)
return e.substring(e.lastIndexOf("/",s)+1,s)},t.isFetchSupported=d,t.isValidFetchUrl=u,t.loadScript=function(e){return new Promise(((t,r)=>{const s=document.createElement("script")
...
return d=d>=0&&d<=59?d:0,"-"===c?(a+=h,o+=d):"+"===c&&(a-=h,o-=d),new Date(Date.UTC(r,n,i,a,o,l))}}},function(e,t,r){"use strict"
...
let t=!1
return Object.defineProperty(e,"settled",{get:()=>t}),e.promise=new Promise((function(r,s){e.resolve=function(e){t=!0,r(e)},e.reject=function(e){t=!0,s(e)}})),e},t.escapeString=function(e){return e.replace(/([\(\)\\])/g,"\\$1")},t.getModificationDate=function(e=new Date(Date.now())){return[e.getUTCFullYear().toString(),(e.getUTCMonth()+1).toString().padStart(2,"0"),(e.getUTCDate()+1).toString().padStart(2,"0"),e.getUTCHours().toString().padStart(2,"0"),e.getUTCMinutes().toString().padStart(2,"0"),e.getUTCSeconds().toString().padStart(2,"0")].join("")},t.getVerbosityLevel=function(){return n},t.info=function(e){n>=s.INFOS&&console.log(`Info: ${e}`)},t.isArrayBuffer=function(e){return"object"==typeof e&&null!==e&&void 0!==e.byteLength},t.isArrayEqual=function(e,t){if(e.length!==t.length)return!1
return e.every((function(e,r){return e===t[r]}))},t.isBool=function(e){return"boolean"==typeof e},t.isNum=function(e){return"number"==typeof e},t.isString=function(e){return"string"==typeof e},t.isSameOrigin=function(e,t){let r
...
t.createObjectURL=_},function(e,t,r){"use strict"
...
const DEFAULT_RANGE_CHUNK_SIZE=65536,RENDERING_CANCELLED_TIMEOUT=100,DefaultCanvasFactory=_is_node.isNodeJS?_node_utils.NodeCanvasFactory:_display_utils.DOMCanvasFactory,DefaultCMapReaderFactory=_is_node.isNodeJS?_node_utils.NodeCMapReaderFactory:_display_utils.DOMCMapReaderFactory
...
u.displayReadyCapability||(u.displayReadyCapability=(0,_util.createPromiseCapability)(),u.operatorList={fnArray:[],argsArray:[],lastChunk:!1},this._stats&&this._stats.time("Page Request"),this._pumpOperatorList({pageIndex:this._pageIndex,intent:d,renderInteractiveForms:!0===n,annotationStorage:c&&c.getAll()||null}))
...
return this.objs.clear(),this.annotationsPromise=null,this.pendingCleanup=!1,Promise.all(e)}cleanup(e=!1){return this.pendingCleanup=!0,this._tryCleanup(e)}_tryCleanup(e=!1){if(!this.pendingCleanup)return!1
for(const{renderTasks:t,operatorList:r}of this._intentStates.values())if(0!==t.length||!r.lastChunk)return!1
return this._intentStates.clear(),this.objs.clear(),this.annotationsPromise=null,e&&this._stats&&(this._stats=new _display_utils.StatTimer),this.pendingCleanup=!1,!0}_startRenderPage(e,t){const r=this._intentStates.get(t)
...
if(t instanceof _display_utils.RenderingCancelledException)return void(e.streamReaderCancelTimeout=setTimeout((()=>{this._abortOperatorList({intentState:e,reason:t,force:!0}),e.streamReaderCancelTimeout=null}),RENDERING_CANCELLED_TIMEOUT))}if(e.streamReader.cancel(new _util.AbortException(t&&t.message)),e.streamReader=null,!this._transport.destroyed){for(const[t,r]of this._intentStates)if(r===e){this._intentStates.delete(t)
...
this._prepareFontLoadEvent([t],[e],s)}))}}_queueLoadingCallback(e){(0,s.unreachable)("Abstract method `_queueLoadingCallback`.")}get isFontLoadingAPISupported(){const e=void 0!==this._document&&!!this._document.fonts
...
return{canvas:r,context:r.getContext("2d")}}},t.NodeCMapReaderFactory=o=class extends s.BaseCMapReaderFactory{_fetchData(e,t){return new Promise(((r,s)=>{require("fs").readFile(e,((e,n)=>{!e&&n?r({cMapData:new Uint8Array(n),compressionType:t}):s(new Error(e))}))}))}})},function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.AnnotationStorage=void 0
t.AnnotationStorage=class{constructor(){this._storage=new Map,this._modified=!1,this.onSetModified=null,this.onResetModified=null}getOrCreateValue(e,t){return this._storage.has(e)?this._storage.get(e):(this._storage.set(e,t),t)}setValue(e,t){this._storage.get(e)!==t&&this._setModified(),this._storage.set(e,t)}getAll(){return 0===this._storage.size?null:Object.fromEntries(this._storage)}get size(){return this._storage.size}_setModified(){this._modified||(this._modified=!0,"function"==typeof this.onSetModified&&this.onSetModified())}resetModified(){this._modified&&(this._modified=!1,"function"==typeof this.onResetModified&&this.onResetModified())}}},function(e,t,r){"use strict"
...
var s=r(2),n=r(11),i=4096,a=.65,o=16
...
var h=function(){function e(){this.alphaIsShape=!1,this.fontSize=0,this.fontSizeScale=1,this.textMatrix=s.IDENTITY_MATRIX,this.textMatrixScale=1,this.fontMatrix=s.FONT_IDENTITY_MATRIX,this.leading=0,this.x=0,this.y=0,this.lineX=0,this.lineY=0,this.charSpacing=0,this.wordSpacing=0,this.textHScale=1,this.textRenderingMode=s.TextRenderingMode.FILL,this.textRise=0,this.fillColor="#000000",this.strokeColor="#000000",this.patternFill=!1,this.fillAlpha=1,this.strokeAlpha=1,this.lineWidth=1,this.activeSMask=null,this.resumeSMaskCtx=null,this.transferMaps=null}return e.prototype={clone:function(){return Object.create(this)},setCurrentPoint:function(e,t){this.x=e,this.y=t}},e}(),d=function(){function e(e,t,r,s,n,i,a){this.ctx=e,this.current=new h,this.stateStack=[],this.pendingClip=null,this.pendingEOFill=!1,this.res=null,this.xobjs=null,this.commonObjs=t,this.objs=r,this.canvasFactory=s,this.webGLContext=n,this.imageLayer=i,this.groupStack=[],this.processingType3=null,this.baseTransform=null,this.baseTransformStack=[],this.groupLevel=0,this.smaskStack=[],this.smaskCounter=0,this.tempSMask=null,this.contentVisible=!0,this.markedContentStack=[],this.optionalContentConfig=a,this.cachedCanvases=new c(this.canvasFactory),e&&l(e),this._cachedGetSinglePixelWidth=null}function t(e,t,r=null){if("undefined"!=typeof ImageData&&t instanceof ImageData)return void e.putImageData(t,0,0)
var n,i,a,l,c,h=t.height,d=t.width,u=h%o,p=(h-u)/o,g=0===u?p:p+1,f=e.createImageData(d,o),m=0,A=t.data,_=f.data
let b,y,v,S
if(r)switch(r.length){case 1:b=r[0],y=r[0],v=r[0],S=r[0]
break
case 4:b=r[0],y=r[1],v=r[2],S=r[3]}if(t.kind===s.ImageKind.GRAYSCALE_1BPP){var C=A.byteLength,x=new Uint32Array(_.buffer,0,_.byteLength>>2),k=x.length,P=d+7>>3,w=4294967295,R=s.IsLittleEndianCached.value?4278190080:255
for(S&&255===S[0]&&0===S[255]&&([w,R]=[R,w]),i=0;i<g;i++){for(l=i<p?o:u,n=0,a=0;a<l;a++){var T=C-m
let e=0
for(var E=T>P?d:8*T-7,F=-8&E,L=0,M=0;e<F;e+=8)M=A[m++],x[n++]=128&M?w:R,x[n++]=64&M?w:R,x[n++]=32&M?w:R,x[n++]=16&M?w:R,x[n++]=8&M?w:R,x[n++]=4&M?w:R,x[n++]=2&M?w:R,x[n++]=1&M?w:R
for(;e<E;e++)0===L&&(M=A[m++],L=128),x[n++]=M&L?w:R,L>>=1}for(;n<k;)x[n++]=0
e.putImageData(f,0,i*o)}}else if(t.kind===s.ImageKind.RGBA_32BPP){const t=!!(b||y||v)
for(a=0,c=d*o*4,i=0;i<p;i++){if(_.set(A.subarray(m,m+c)),m+=c,t)for(let e=0;e<c;e+=4)b&&(_[e+0]=b[_[e+0]]),y&&(_[e+1]=y[_[e+1]]),v&&(_[e+2]=v[_[e+2]])
e.putImageData(f,0,a),a+=o}if(i<g){if(c=d*u*4,_.set(A.subarray(m,m+c)),t)for(let e=0;e<c;e+=4)b&&(_[e+0]=b[_[e+0]]),y&&(_[e+1]=y[_[e+1]]),v&&(_[e+2]=v[_[e+2]])
e.putImageData(f,0,a)}}else{if(t.kind!==s.ImageKind.RGB_24BPP)throw new Error(`bad image kind: ${t.kind}`)
{const t=!!(b||y||v)
for(c=d*(l=o),i=0;i<g;i++){for(i>=p&&(c=d*(l=u)),n=0,a=c;a--;)_[n++]=A[m++],_[n++]=A[m++],_[n++]=A[m++],_[n++]=255
if(t)for(let e=0;e<n;e+=4)b&&(_[e+0]=b[_[e+0]]),y&&(_[e+1]=y[_[e+1]]),v&&(_[e+2]=v[_[e+2]])
e.putImageData(f,0,i*o)}}}}function r(e,t){for(var r=t.height,s=t.width,n=r%o,i=(r-n)/o,a=0===n?i:i+1,l=e.createImageData(s,o),c=0,h=t.data,d=l.data,u=0;u<a;u++){for(var p=u<i?o:n,g=3,f=0;f<p;f++)for(var m=0,A=0;A<s;A++){if(!m){var _=h[c++]
m=128}d[g]=_&m?0:255,g+=4,m>>=1}e.putImageData(l,0,u*o)}}function d(e,t){for(var r=["strokeStyle","fillStyle","fillRule","globalAlpha","lineWidth","lineCap","lineJoin","miterLimit","globalCompositeOperation","font"],s=0,n=r.length;s<n;s++){var i=r[s]
...
o="Luminosity"===n?f:g
for(var u=Math.min(s,Math.ceil(1048576/r)),m=0;m<s;m+=u){var A=Math.min(u,s-m),_=e.getImageData(0,m,r,A),b=t.getImageData(0,m,r,A)
l&&p(_.data,c,h,d),o(_.data,b.data,a),e.putImageData(b,0,m)}})(i,r,n.width,n.height,t.subtype,a,t.transferMap),e.drawImage(n,0,0)}var A=["butt","round","square"],_=["miter","round","bevel"],b={},y={}
...
break
case"TR":this.current.transferMaps=i}}},beginSMaskGroup:function(){var e=this.current.activeSMask,t=e.canvas.width,r=e.canvas.height,s="smaskGroupAt"+this.groupLevel,n=this.cachedCanvases.getCanvas(s,t,r,!0),i=this.ctx,a=i.mozCurrentTransform
this.ctx.save()
var o=n.context
...
var h=t[l++],d=t[l++]
0===h&&r.lineWidth<this.getSinglePixelWidth()&&(h=this.getSinglePixelWidth()),0===d&&r.lineWidth<this.getSinglePixelWidth()&&(d=this.getSinglePixelWidth())
var u=i+h,p=a+d
r.moveTo(i,a),r.lineTo(u,a),r.lineTo(u,p),r.lineTo(i,p),r.lineTo(i,a),r.closePath()
break
...
_=i.mozCurrentTransform,i.restore(),i.fillStyle=e}i.transform.apply(i,t.textMatrix),i.translate(t.x,t.y+t.textRise),h>0?i.scale(d,-1):i.scale(d,1)
var b=t.lineWidth,y=t.textMatrixScale
if(0===y||0===b){var v=t.textRenderingMode&s.TextRenderingMode.FILL_STROKE_MASK
v!==s.TextRenderingMode.STROKE&&v!==s.TextRenderingMode.FILL_STROKE||(this._cachedGetSinglePixelWidth=null,b=this.getSinglePixelWidth()*a)}else b/=y
1!==o&&(i.scale(o,o),b/=o),i.lineWidth=b
var S,C=0
for(S=0;S<u;++S){var x=e[S]
if((0,s.isNum)(x))C+=g*x*n/1e3
else{var k,P,w,R,T,E,F,L=!1,M=(x.isSpace?c:0)+l,O=x.fontChar,I=x.accent,D=x.width
if(p)T=x.vmetric||f,E=-(E=x.vmetric?T[1]:.5*D)*m,F=T[2]*m,D=T?-T[0]:D,k=E/o,P=(C+F)/o
else k=C/o,P=0
if(r.remeasure&&D>0){var N=1e3*i.measureText(O).width/n*o
if(D<N&&this.isFontSubpixelAAEnabled){var j=D/N
L=!0,i.save(),i.scale(j,1),k/=j}else D!==N&&(k+=(D-N)/2e3*n/o)}this.contentVisible&&(x.isInFont||r.missingFile)&&(A&&!I?i.fillText(O,k,P):(this.paintChar(O,k,P,_),I&&(w=k+n*I.offset.x/o,R=P-n*I.offset.y/o,this.paintChar(I.fontChar,w,R,_)))),C+=p?D*m-M*h:D*m+M*h,L&&i.restore()}}p?t.y-=C:t.x+=C*d,i.restore()},showType3Text:function(e){var t,r,n,i,a=this.ctx,o=this.current,l=o.font,c=o.fontSize,h=o.fontDirection,d=l.vertical?1:-1,u=o.charSpacing,p=o.wordSpacing,g=o.textHScale*h,f=o.fontMatrix||s.FONT_IDENTITY_MATRIX,m=e.length
...
else{var A=(r.isSpace?p:0)+u,_=l.charProcOperatorList[r.operatorListId]
if(_)this.contentVisible&&(this.processingType3=r,this.save(),a.scale(c,c),a.transform.apply(a,f),this.executeOperatorList(_),this.restore()),n=s.Util.applyTransform([r.width,0],f)[0]*c+A,a.translate(n,0),o.x+=n*g
...
this.ctx.fillStyle=n,this.current.fillColor=n,this.current.patternFill=!1},shadingFill:function(e){if(this.contentVisible){var t=this.ctx
this.save()
...
this.restore()}},beginInlineImage:function(){(0,s.unreachable)("Should not call beginInlineImage")},beginImageData:function(){(0,s.unreachable)("Should not call beginImageData")},paintFormXObjectBegin:function(e,t){if(this.contentVisible&&(this.save(),this.baseTransformStack.push(this.baseTransform),Array.isArray(e)&&6===e.length&&this.transform.apply(this,e),this.baseTransform=this.ctx.mozCurrentTransform,t)){var r=t[2]-t[0],s=t[3]-t[1]
this.ctx.rect(t[0],t[1],r,s),this.clip(),this.endPath()}},paintFormXObjectEnd:function(){this.contentVisible&&(this.restore(),this.baseTransform=this.baseTransformStack.pop())},beginGroup:function(e){if(this.contentVisible){this.save()
var t=this.ctx
...
m.scale(1/u,1/p),m.translate(-o,-l),m.transform.apply(m,r),e.smask?this.smaskStack.push({canvas:f.canvas,context:m,offsetX:o,offsetY:l,scaleX:u,scaleY:p,subtype:e.smask.subtype,backdrop:e.smask.backdrop,transferMap:e.smask.transferMap||null,startTransformInverse:null}):(t.setTransform(1,0,0,1,0,0),t.translate(o,l),t.scale(u,p)),d(t,m),this.ctx=m,this.setGState([["BM","source-over"],["ca",1],["CA",1]]),this.groupStack.push(t),this.groupLevel++,this.current.activeSMask=null}},endGroup:function(e){if(this.contentVisible){this.groupLevel--
var t=this.ctx
...
this.ctx.rect(e[0],e[1],s,n),this.clip(),this.endPath()}this.transform.apply(this,t),this.transform.apply(this,r)},endAnnotation:function(){this.restore()},paintImageMaskXObject:function(e){if(this.contentVisible){var t=this.ctx,s=e.width,n=e.height,i=this.current.fillColor,a=this.current.patternFill,o=this.processingType3
...
var _=new Int32Array([0,o,-1,0,-o,0,0,0,1]),b=[]
for(t=0;m&&t<=a;t++){for(var y=t*o,v=y+i;y<v&&!l[y];)y++
if(y!==v){var S,C=[y%o,t],x=l[y],k=y
do{var P=_[x]
do{y+=P}while(!l[y])
5!==(S=l[y])&&10!==S?(x=S,l[y]=0):(x=S&51*x>>4,l[y]&=x>>2|x<<2),C.push(y%o),C.push(y/o|0),l[y]||--m}while(k!==y)
b.push(C),--t}}return function(e){e.save(),e.scale(1/i,-1/a),e.translate(0,-a),e.beginPath()
for(let r=0,s=b.length;r<s;r++){var t=b[r]
e.moveTo(t[0],t[1])
...
c.save(),r(c,e),c.globalCompositeOperation="source-in",c.fillStyle=a?i.getPattern(c,this):i,c.fillRect(0,0,s,n),c.restore(),this.paintInlineImageXObject(l.canvas)}}},paintImageMaskXObjectRepeat(e,t,s=0,n=0,i,a){if(this.contentVisible){var o=e.width,l=e.height,c=this.current.fillColor,h=this.current.patternFill,d=this.cachedCanvases.getCanvas("maskCanvas",o,l),u=d.context
u.save(),r(u,e),u.globalCompositeOperation="source-in",u.fillStyle=h?c.getPattern(u,this):c,u.fillRect(0,0,o,l),u.restore()
for(var p=this.ctx,g=0,f=a.length;g<f;g+=2)p.save(),p.transform(t,s,n,i,a[g],a[g+1]),p.scale(1,-1),p.drawImage(d.canvas,0,0,o,l,0,-1,1,1),p.restore()}},paintImageMaskXObjectGroup:function(e){if(this.contentVisible)for(var t=this.ctx,s=this.current.fillColor,n=this.current.patternFill,i=0,a=e.length;i<a;i++){var o=e[i],l=o.width,c=o.height,h=this.cachedCanvases.getCanvas("maskCanvas",l,c),d=h.context
d.save(),r(d,o),d.globalCompositeOperation="source-in",d.fillStyle=n?s.getPattern(d,this):s,d.fillRect(0,0,l,c),d.restore(),t.save(),t.transform.apply(t,o.transform),t.scale(1,-1),t.drawImage(h.canvas,0,0,l,c,0,-1,1,1),t.restore()}},paintImageXObject:function(e){if(!this.contentVisible)return
...
this.paintInlineImageXObjectGroup(i,l)}else(0,s.warn)("Dependent image isn't ready yet")},paintInlineImageXObject:function(e){if(this.contentVisible){var r=e.width,s=e.height,n=this.ctx
...
t(g,e,this.current.transferMaps),i=a.canvas}for(var f=r,m=s,A="prescale1";h>2&&f>1||p>2&&m>1;){var _=f,b=m
h>2&&f>1&&(h/=f/(_=Math.ceil(f/2))),p>2&&m>1&&(p/=m/(b=Math.ceil(m/2))),(g=(a=this.cachedCanvases.getCanvas(A,_,b)).context).clearRect(0,0,_,b),g.drawImage(i,0,0,f,m,0,0,_,b),i=a.canvas,f=_,m=b,A="prescale1"===A?"prescale2":"prescale1"}if(n.drawImage(i,0,0,f,m,0,-s,r,s),this.imageLayer){var y=this.getCanvasPosition(0,-s)
this.imageLayer.appendImage({imgData:e,left:y[0],top:y[1],width:r/o[0],height:s/o[3]})}this.restore()}},paintInlineImageXObjectGroup:function(e,r){if(this.contentVisible){var s=this.ctx,n=e.width,i=e.height,a=this.cachedCanvases.getCanvas("inlineImage",n,i)
...
return!0}},s.OPS)e.prototype[s.OPS[v]]=e.prototype[v]
return e}()
...
var p=(c[r]+t.offsetX)*t.scaleX,g=(c[r+1]+t.offsetY)*t.scaleY,f=(c[s]+t.offsetX)*t.scaleX,m=(c[s+1]+t.offsetY)*t.scaleY,A=(c[n]+t.offsetX)*t.scaleX,_=(c[n+1]+t.offsetY)*t.scaleY
if(!(g>=_))for(var b,y,v,S,C,x,k,P,w=h[i],R=h[i+1],T=h[i+2],E=h[a],F=h[a+1],L=h[a+2],M=h[o],O=h[o+1],I=h[o+2],D=Math.round(g),N=Math.round(_),j=D;j<=N;j++){if(j<m){let e
e=j<g?0:g===m?1:(g-j)/(g-m),b=p-(p-f)*e,y=w-(w-E)*e,v=R-(R-F)*e,S=T-(T-L)*e}else{let e
e=j>_?1:m===_?0:(m-j)/(m-_),b=f-(f-A)*e,y=E-(E-M)*e,v=F-(F-O)*e,S=L-(L-I)*e}let e
e=j<g?0:j>_?1:(g-j)/(g-_),C=p-(p-A)*e,x=w-(w-M)*e,k=R-(R-O)*e,P=T-(T-I)*e
for(var U=Math.round(Math.min(b,C)),W=Math.round(Math.max(b,C)),q=u*j+4*U,G=U;G<=W;G++)e=(b-G)/(b-C),e<0?e=0:e>1&&(e=1),d[q++]=y-(y-x)*e|0,d[q++]=v-(v-k)*e|0,d[q++]=S-(S-P)*e|0,d[q++]=255}}function t(t,r,s){var n,i,a=r.coords,o=r.colors
...
break
default:throw new Error("illegal figure")}}return function(e,r,s,n,i,a,o,l){var c,h,d,u,p=Math.floor(e[0]),g=Math.floor(e[1]),f=Math.ceil(e[2])-p,m=Math.ceil(e[3])-g,A=Math.min(Math.ceil(Math.abs(f*r[0]*1.1)),3e3),_=Math.min(Math.ceil(Math.abs(m*r[1]*1.1)),3e3),b=f/A,y=m/_,v={coords:s,colors:n,offsetX:-p,offsetY:-g,scaleX:1/b,scaleY:1/y},S=A+4,C=_+4
if(l.isEnabled)c=l.drawFigures({width:A,height:_,backgroundColor:a,figures:i,context:v}),(h=o.getCanvas("mesh",S,C,!1)).context.drawImage(c,2,2),c=h.canvas
else{var x=(h=o.getCanvas("mesh",S,C,!1)).context,k=x.createImageData(A,_)
if(a){var P=k.data
for(d=0,u=P.length;d<u;d+=4)P[d]=a[0],P[d+1]=a[1],P[d+2]=a[2],P[d+3]=255}for(d=0;d<i.length;d++)t(k,i[d],v)
x.putImageData(k,2,2),c=h.canvas}return{canvas:c,offsetX:p-2*b,offsetY:g-2*y,scaleX:b,scaleY:y}}}()
...
var h=r[0],d=r[1],u=r[2],p=r[3],g=s.Util.singularValueDecompose2dScale(this.matrix),f=s.Util.singularValueDecompose2dScale(this.baseTransform),m=[g[0]*f[0],g[1]*f[1]],A=this.getSizeAndScale(n,this.ctx.canvas.width,m[0]),_=this.getSizeAndScale(i,this.ctx.canvas.height,m[1]),b=e.cachedCanvases.getCanvas("pattern",A.size,_.size,!0),y=b.context,v=c.createCanvasGraphics(y)
return v.groupLevel=e.groupLevel,this.setFillAndStrokeStyleToContext(v,a,l),v.transform(A.scale,0,0,_.scale,0,0),v.transform(1,0,0,1,-h,-d),this.clipBbox(v,r,h,d,u,p),v.executeOperatorList(t),this.ctx.transform(1,0,0,1,h,d),this.ctx.scale(1/A.scale,1/_.scale),b.canvas},getSizeAndScale:function(e,t,r){e=Math.abs(e)
...
this._metadataMap.set(s,r.textContent.trim())}}}get(e){return this._metadataMap.has(e)?this._metadataMap.get(e):null}getAll(){return Object.fromEntries(this._metadataMap)}has(e){return this._metadataMap.has(e)}}},function(e,t,r){"use strict"
...
var m=n(f,e,f.TEXTURE0),A=n(f,c,f.TEXTURE1),_=f.createBuffer()
return f.bindBuffer(f.ARRAY_BUFFER,_),f.bufferData(f.ARRAY_BUFFER,new Float32Array([0,0,d,0,0,u,0,u,d,0,d,u]),f.STATIC_DRAW),f.enableVertexAttribArray(p.positionLocation),f.vertexAttribPointer(p.positionLocation,2,f.FLOAT,!1,0,0),f.clearColor(0,0,0,0),f.enable(f.BLEND),f.blendFunc(f.ONE,f.ONE_MINUS_SRC_ALPHA),f.clear(f.COLOR_BUFFER_BIT),f.drawArrays(f.TRIANGLES,0,6),f.flush(),f.deleteTexture(m),f.deleteTexture(A),f.deleteBuffer(_),g},drawFigures:function(e,n,l,h,d){c||function(){var e,n
o(),e=a,a=null,n=i,i=null
...
var f,m,A,_=0
for(f=0,m=h.length;f<m;f++)switch(h[f].type){case"lattice":_+=((A=h[f].coords.length/h[f].verticesPerRow|0)-1)*(h[f].verticesPerRow-1)*6
break
case"triangles":_+=h[f].coords.length}var b=new Float32Array(2*_),y=new Uint8Array(3*_),v=d.coords,S=d.colors,C=0,x=0
for(f=0,m=h.length;f<m;f++){var k=h[f],P=k.coords,w=k.colors
switch(k.type){case"lattice":var R=k.verticesPerRow
A=P.length/R|0
for(var T=1;T<A;T++)for(var E=T*R+1,F=1;F<R;F++,E++){b[C]=v[P[E-R-1]],b[C+1]=v[P[E-R-1]+1],b[C+2]=v[P[E-R]],b[C+3]=v[P[E-R]+1],b[C+4]=v[P[E-1]],b[C+5]=v[P[E-1]+1],y[x]=S[w[E-R-1]],y[x+1]=S[w[E-R-1]+1],y[x+2]=S[w[E-R-1]+2],y[x+3]=S[w[E-R]],y[x+4]=S[w[E-R]+1],y[x+5]=S[w[E-R]+2],y[x+6]=S[w[E-1]],y[x+7]=S[w[E-1]+1],y[x+8]=S[w[E-1]+2],b[C+6]=b[C+2],b[C+7]=b[C+3],b[C+8]=b[C+4],b[C+9]=b[C+5],b[C+10]=v[P[E]],b[C+11]=v[P[E]+1],y[x+9]=y[x+3],y[x+10]=y[x+4],y[x+11]=y[x+5],y[x+12]=y[x+6],y[x+13]=y[x+7],y[x+14]=y[x+8],y[x+15]=S[w[E]],y[x+16]=S[w[E]+1],y[x+17]=S[w[E]+2]
C+=12,x+=18}break
case"triangles":for(var L=0,M=P.length;L<M;L++)b[C]=v[P[L]],b[C+1]=v[P[L]+1],y[x]=S[w[L]],y[x+1]=S[w[L]+1],y[x+2]=S[w[L]+2],C+=2,x+=3}}l?g.clearColor(l[0]/255,l[1]/255,l[2]/255,1):g.clearColor(0,0,0,0),g.clear(g.COLOR_BUFFER_BIT)
var O=g.createBuffer()
g.bindBuffer(g.ARRAY_BUFFER,O),g.bufferData(g.ARRAY_BUFFER,b,g.STATIC_DRAW),g.enableVertexAttribArray(u.positionLocation),g.vertexAttribPointer(u.positionLocation,2,g.FLOAT,!1,0,0)
var I=g.createBuffer()
return g.bindBuffer(g.ARRAY_BUFFER,I),g.bufferData(g.ARRAY_BUFFER,y,g.STATIC_DRAW),g.enableVertexAttribArray(u.colorLocation),g.vertexAttribPointer(u.colorLocation,3,g.UNSIGNED_BYTE,!1,0,0),g.uniform2f(u.scaleLocation,d.scaleX,d.scaleY),g.uniform2f(u.offsetLocation,d.offsetX,d.offsetY),g.drawArrays(g.TRIANGLES,0,_),g.flush(),g.deleteBuffer(O),g.deleteBuffer(I),p},cleanup(){l&&l.canvas&&(l.canvas.width=0,l.canvas.height=0),c&&c.canvas&&(c.canvas.width=0,c.canvas.height=0),l=null,c=null}}}()},function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.AnnotationLayer=void 0
var s=r(1),n=r(2),i=r(8)
class a{static create(e){switch(e.data.annotationType){case n.AnnotationType.LINK:return new l(e)
case n.AnnotationType.TEXT:return new c(e)
case n.AnnotationType.WIDGET:switch(e.data.fieldType){case"Tx":return new d(e)
case"Btn":return e.data.radioButton?new p(e):e.data.checkBox?new u(e):new g(e)
case"Ch":return new f(e)}return new h(e)
case n.AnnotationType.POPUP:return new m(e)
case n.AnnotationType.FREETEXT:return new _(e)
case n.AnnotationType.LINE:return new b(e)
case n.AnnotationType.SQUARE:return new y(e)
case n.AnnotationType.CIRCLE:return new v(e)
case n.AnnotationType.POLYLINE:return new S(e)
...
case n.AnnotationType.UNDERLINE:return new w(e)
case n.AnnotationType.SQUIGGLY:return new R(e)
case n.AnnotationType.STRIKEOUT:return new T(e)
case n.AnnotationType.STAMP:return new E(e)
case n.AnnotationType.FILEATTACHMENT:return new F(e)
default:return new o(e)}}}class o{constructor(e,t=!1,r=!1){this.isRenderable=t,this.data=e.data,this.layer=e.layer,this.page=e.page,this.viewport=e.viewport,this.linkService=e.linkService,this.downloadManager=e.downloadManager,this.imageResourcesPath=e.imageResourcesPath,this.renderInteractiveForms=e.renderInteractiveForms,this.svgFactory=e.svgFactory,this.annotationStorage=e.annotationStorage,t&&(this.container=this._createContainer(r))}_createContainer(e=!1){const t=this.data,r=this.page,s=this.viewport,i=document.createElement("section")
...
const s=new A({container:e,trigger:t,color:r.color,title:r.title,modificationDate:r.modificationDate,contents:r.contents,hideWrapper:!0}).render()
s.style.left=e.style.width,e.appendChild(s)}render(){(0,n.unreachable)("Abstract method `AnnotationElement.render` called")}}class l extends o{constructor(e){super(e,!!(e.data.url||e.data.dest||e.data.action))}render(){this.container.className="linkAnnotation"
const{data:e,linkService:t}=this,r=document.createElement("a")
return e.url?(0,s.addLinkAttributes)(r,{url:e.url,target:e.newWindow?s.LinkTarget.BLANK:t.externalLinkTarget,rel:t.externalLinkRel,enabled:t.externalLinkEnabled}):e.action?this._bindNamedAction(r,e.action):this._bindLink(r,e.dest),this.container.appendChild(r),this.container}_bindLink(e,t){e.href=this.linkService.getDestinationHash(t),e.onclick=()=>(t&&this.linkService.navigateTo(t),!1),t&&(e.className="internalLink")}_bindNamedAction(e,t){e.href=this.linkService.getAnchorUrl(""),e.onclick=()=>(this.linkService.executeNamedAction(t),!1),e.className="internalLink"}}class c extends o{constructor(e){super(e,!!(e.data.hasPopup||e.data.title||e.data.contents))}render(){this.container.className="textAnnotation"
...
let s=null
if(this.renderInteractiveForms){const e=t.getOrCreateValue(r,this.data.fieldValue)
if(this.data.multiLine?(s=document.createElement("textarea"),s.textContent=e):(s=document.createElement("input"),s.type="text",s.setAttribute("value",e)),s.addEventListener("input",(function(e){t.setValue(r,e.target.value)})),s.disabled=this.data.readOnly,s.name=this.data.fieldName,null!==this.data.maxLen&&(s.maxLength=this.data.maxLen),this.data.comb){const e=(this.data.rect[2]-this.data.rect[0])/this.data.maxLen
...
let e=null
this.data.fontRefName&&this.page.commonObjs.has(this.data.fontRefName)&&(e=this.page.commonObjs.get(this.data.fontRefName)),this._setTextStyle(s,e)}return null!==this.data.textAlignment&&(s.style.textAlign=e[this.data.textAlignment]),this.container.appendChild(s),this.container}_setTextStyle(e,t){const r=e.style
...
r.fontFamily=n+i}}class u extends h{constructor(e){super(e,e.renderInteractiveForms)}render(){const e=this.annotationStorage,t=this.data,r=t.id,s=e.getOrCreateValue(r,t.fieldValue&&"Off"!==t.fieldValue)
this.container.className="buttonWidgetAnnotation checkBox"
const n=document.createElement("input")
return n.disabled=t.readOnly,n.type="checkbox",n.name=this.data.fieldName,s&&n.setAttribute("checked",!0),n.addEventListener("change",(function(t){e.setValue(r,t.target.checked)})),this.container.appendChild(n),this.container}}class p extends h{constructor(e){super(e,e.renderInteractiveForms)}render(){this.container.className="buttonWidgetAnnotation radioButton"
const e=this.annotationStorage,t=this.data,r=t.id,s=e.getOrCreateValue(r,t.fieldValue===t.buttonValue),n=document.createElement("input")
return n.disabled=t.readOnly,n.type="radio",n.name=t.fieldName,s&&n.setAttribute("checked",!0),n.addEventListener("change",(function(t){const s=t.target.name
for(const r of document.getElementsByName(s))r!==t.target&&e.setValue(r.parentNode.getAttribute("data-annotation-id"),!1)
e.setValue(r,t.target.checked)})),this.container.appendChild(n),this.container}}class g extends l{render(){const e=super.render()
return e.className="buttonWidgetAnnotation pushButton",e}}class f extends h{constructor(e){super(e,e.renderInteractiveForms)}render(){this.container.className="choiceWidgetAnnotation"
...
e.textContent=s.displayValue,e.value=s.exportValue,this.data.fieldValue.includes(s.exportValue)&&e.setAttribute("selected",!0),r.appendChild(e)}return r.addEventListener("input",(function(r){const s=r.target.options,n=s[s.selectedIndex].value
e.setValue(t,n)})),this.container.appendChild(r),this.container}}class m extends o{constructor(e){super(e,!(!e.data.title&&!e.data.contents))}render(){if(this.container.className="popupAnnotation",["Line","Square","Circle","PolyLine","Polygon","Ink"].includes(this.data.parentType))return this.container
const e=`[data-annotation-id="${this.data.parentId}"]`,t=this.layer.querySelector(e)
if(!t)return this.container
const r=new A({container:this.container,trigger:t,color:this.data.color,title:this.data.title,modificationDate:this.data.modificationDate,contents:this.data.contents}),s=parseFloat(t.style.left),n=parseFloat(t.style.width)
...
r.length&&t.push(...r)
for(const n of t){const t=a.create({data:n,layer:e.div,page:e.page,viewport:e.viewport,linkService:e.linkService,downloadManager:e.downloadManager,imageResourcesPath:e.imageResourcesPath||"",renderInteractiveForms:"boolean"!=typeof e.renderInteractiveForms||e.renderInteractiveForms,svgFactory:new s.DOMSVGFactory,annotationStorage:e.annotationStorage||new i.AnnotationStorage})
...
var _,b,y=(h.vertical?r.height:r.width)*t._viewport.scale,v=d
0!==c?(_=[m,A,-A,m,p,g],b=s.Util.getAxialAlignedBoundingBox([0,0,y,v],_)):b=[p,g,p+y,g+v],t._bounds.push({left:b[0],top:b[1],right:b[2],bottom:b[3],div:a,size:[y,v],m:_})}}function r(e){if(!e._canceled){var t=e._textDivs,r=e._capability,s=t.length
...
return r instanceof Uint8Array?r:new Uint8Array(r)}catch(t){(0,s.warn)("Not compressing PNG because zlib.deflateSync is unavailable: "+t)}return n(e)}(f),y=e.length+36+_.length+b.length,v=new Uint8Array(y)
let S=0
return v.set(e,S),S+=e.length,r("IHDR",_,v,S),S+=12+_.length,r("IDATA",b,v,S),S+=12+b.length,r("IEND",new Uint8Array(0),v,S),(0,s.createObjectURL)(v,"image/png",o)}return function(e,t,r){return a(e,void 0===e.kind?s.ImageKind.GRAYSCALE_1BPP:e.kind,t,r)}}()
...
if(this.svg=w,this.transformMatrix=n,2===d){const e=s.Util.makeCssRgb(...t)
...
var s=r(2),n=r(24)},function(e,t,r){"use strict"
...
this._readCapability.resolve(),this._reader=e.body.getReader()})).catch((e=>{if(!e||"AbortError"!==e.name)throw e})),this.onProgress=null}get isStreamingSupported(){return this._isStreamingSupported}async read(){await this._readCapability.promise
const{value:e,done:t}=await this._reader.read()
if(t)return{value:e,done:t}
